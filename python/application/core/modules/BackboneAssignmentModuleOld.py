...
from application.core.popups.InterIntraSpectrumPopup import InterIntraSpectrumPopup
from application.core.popups.SelectSpectrumDisplayPopup import SelectSpectrumDisplayPopup
