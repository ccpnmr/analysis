...
class PulldownList(QtGui.QComboBox, Base):
  ...
  def setSelected(self, item, doCallback=False):
    ...
    print("application.core.widgets.PulldownList.setSelected is depecated use; .select()")
  ...
  def getSelected(self):
    ...
    print("application.core.widgets.PulldownList.getSelected is depecated use; .currentData()")

    return self.currentData()

  def getObject(self):
    
    print("application.core.widgets.PulldownList.getObject is depecated use; .currentObject()")
    
    return self.currentObject()

  def getText(self):
    
    print("application.core.widgets.PulldownList.getText is depecated use; .currentText()")
   
    return self.currentText()

  def getSelectedIndex(self):
    
    print("application.core.widgets.PulldownList.getSelectedIndex is depecated use; .currentIndex()")

    return self.currentIndex()

  def setup(self):
    
    print("application.core.widgets.PulldownList.setup is depecated use; .setData")
