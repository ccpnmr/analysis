...
- *ccpn.Project* - The Project (root)containing the object.

**pid**

- *ccpncore.util.Pid.Pid* - Identifier for the object, unique within the project.
...
Most objects can be created by calling a *newXyzObject* method on the parent.
E.g. you can create a new Restraint object with the myRestraintList.newRestraint function.
'new' functions create the directly contained objects, using hte passed-in parameters.

More complex object creation is done with 'create' functions, that may create multiple
contained objects, adn use heuristics to fill in missing parameters.
