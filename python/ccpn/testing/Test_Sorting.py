...
class CcpnSortingTest(SortingData):
  ...
  data7 = ['@1.127b..H@15', '@1.127b-1..H@2', '@1.127b+0..H@2','@1.127b-0..H@2','@1.127b+1..H@2',
           '@1.127b1..H@2',]
  pids = [ 'NR:@-.@1', 'NR:@-.@1.', 'NR:@-.@1-1.', 'NR:@-.@1+0.', 'NR:@-.@1+1.',]
  sequenceCodes = ['-1', ' 1', '+1', '1',  '1b', '1.', '2b', '2b.', '2b-11', '2b-2.', '2b-1', '2b+0', '2b-0',
                   '2b0', '2b+1', '2b+2', '2b2', '2b@11', '2ba', '15.',  '#1', '#2', '#11', '#11-1',
                   '#11+1',  '#105', '@-11', '@-2', '@-1', '@0', '@1', '@2', '@11', '@-', '@@a',
                   '@A']

  def test_string_sorting_1(self):
    print ('@~@~ test_string_sorting_1')
    for ll in self.data1:
      ll2 = sorted(list(reversed(ll)), key=self.sortKeys['string'])
      # print ('->', ll)
      # print ('  ', ll2)
