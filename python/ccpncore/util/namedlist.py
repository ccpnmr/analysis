...
#=========================================================================================
__copyright__ = "Copyright 2011-2014 True Blade Systems, Inc."
__credits__ = "Eric V. Smith; https://bitbucket.org/ericvsmith/namedlist; email: eric@trueblade.com"
...
#
# Modified  - Rasmus Fogh, ccpn project http://www.ccpn.ac.uk 18/2/2016
# Added bases parameter to allow passing in superclasses for additional functionality
#
#
# def namedlist(typename, field_names, default=NO_DEFAULT, rename=False,
#               use_slots=True):
def namedlist(typename, field_names, default=NO_DEFAULT, rename=False,
              use_slots=True, bases=(object,)):
    ...
    t = type(typename, bases, type_dict)
