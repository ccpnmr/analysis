...
class PopupGenerator(QtGui.QDialog, Base):
  ...
  def renderPopup(self):
    ...
    # copyfile(pythonFile, '/Users/simon1/PycharmProjects/CCPN_V3/trunk/ccpnv3/python/ccpnmrcore/modules/%s.py' % self.popupNameBox.text() )
    # package = 'ccpnmrcore.modules.'+self.popupNameBox.text()
    # print(package)
