...
class GuiSpectrumView1d(GuiSpectrumView):
  ...
  def __init__(self, guiSpectrumDisplay1d, apiSpectrumView, spectralData=None, dimMapping=None):
    ...
    """
    GuiSpectrumView.__init__(self, guiSpectrumDisplay1d, apiSpectrumView, dimMapping)
