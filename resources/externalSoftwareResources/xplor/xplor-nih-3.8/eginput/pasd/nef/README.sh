...
spectra="CNOESY-173\`3\` 3dNOESY-182\`3\` NOE2-2\`3\`"

# optional distance restraint names
distRestraints="-dist \`20\`hBond"
...
xplor jointFilter.py $distRestraints ${name}_new.nef *pass1.pasd
