...
rampedParams.append( StaticRamp('''cooling_updateTerms(pasdTerms,
                                  rampInfo.fractionDone,
                                  rampInfo.numSteps,
                                  distViolWeight=(0.5,1),
                                  prevLikeliWeight=(0.5,0),
                                  noeCompleteWeight=(0,0),
                                  charDistViol=(2.0,0.7),
                                  charNoeComplete=(0,0),
                                  charScatter=(0.02,0.02),
                                  charDeltaDV=(0.33,0.0033),
                                  charDeltaNoeComplete=(0.01,0.01),
                                  charDeltaScatter=(0.01,0.01),
                                  )''') )
...
#    protocol.writePDB(loopInfo.filename()+".init")
    ...
    protocol.initDynamics(dyn,
                          ...
                          bathTemp=init_t,
                          initVelocities=1,
                          finalTime=50./numHighTempReshuffles,  
...
structTemplate = sl.pdbTemplate.replace("SCRIPT","pass3")
