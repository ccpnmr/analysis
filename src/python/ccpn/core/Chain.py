...
__dateModified__ = "$dateModified: 2021-04-06 12:45:57 +0100 (Tue, April 06, 2021) $"
...
def _newChainFromChemComp(project, chemComp,
    ...
    if chemComp:
        with undoBlock():
            ...
            # remove the autoGenerated atoms until we can pass-in options in the expandMolSystemAtoms directly on creation
            _removeWronglyCreatedAtoms = [residue._removeNonChemAtoms() for residue in chain.residues]
