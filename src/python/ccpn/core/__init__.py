...
A **SpectrumHit** object is used in screening and metabolomics implementations to describe
...
A **Collection** is a container, a set of core objects. It can also contain nested collections.
...
Identifier for the object, used to generate the pid.
...
SPECTRUM_CLASSNAME = _Spectrum.className
