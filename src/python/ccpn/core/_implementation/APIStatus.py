...
class APIStatus(object):
    ...
    Each row is a unique API object that has been checked for its validity.
    ...
    def __init__(self, apiObj, build=True, onlyInvalids=True, completeScan=False, includeDefaultChildren=False, checkValidity=True):
        ...
        self._checkValidity = checkValidity
    ...
    def buildAll(self, obj, level=0, methodNames=None):
        ...
        for childrenMethodName in methodNames:
            ...
            for child in children:
                isValid, errMesg = self._getIsValidStatus(child) if self._checkValidity else [None, None]
