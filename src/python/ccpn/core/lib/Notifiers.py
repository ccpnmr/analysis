...
class NotifierBase(object):
    ...
    def setNotifier(self, theObject: V3CoreType, triggers: list|tuple, targetName: str|list|tuple|None,
                    callback: Callable[..., Optional[str]], **kwds) -> _NotifierList:
    ...
    def setGuiNotifier(self, theObject: V3CoreType,
                       triggers: list, targetNames: list,
                       callback: Callable[..., Optional[str]]) -> _NotifierList:
