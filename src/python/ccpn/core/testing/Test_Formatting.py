...
class StringifierTest(WrapperTesting):
    ...
    def test_defaultFormatting(self):
        ...
        toString = commonUtil.stringifier('serial', 'peakList', 'height', 'volume', 'className',
                                          ...
                                          'dimensionNmrAtoms')
        self.assertEqual(toString(peak), "<PK:15NNoesy_182.1.3| serial=3, peakList=<PL:15NNoesy_182.1>, "
    ...
    def test_userFormatting(self):
        ...
        self.assertEqual(toString(peak), "<PK:hsqc_115.1.1| serial=1, peakList=<PL:hsqc_115.1>, height=16455916.000,"
