...
class RestraintTableTest(WrapperTesting):
    ...
    def test_newDistanceRestraintTable(self):
        ...
        self.undo.undo()
        self.assertEqual(len(dataSet.restraintTables), 0)
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'Distance')
    ...
    def test_newDihedralRestraintTable(self):
        ...
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'Dihedral')
    ...
    def test_newCsaRestraintTable(self):
        ...
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'Csa')
    ...
    def test_newRdcRestraintTable(self):
        ...
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'Rdc')
    ...
    def test_newChemicalShiftRestraintTable(self):
        ...
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'ChemicalShift')
    ...
    def test_newJCouplingRestraintTable(self):
        ...
        self.undo.redo()
        self.assertEqual(len(dataSet.restraintTables), 1)
        self.assertEqual(dataSet.restraintTables[0].restraintType, 'JCoupling')
