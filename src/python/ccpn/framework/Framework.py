...
class Framework(HasCcpNmrProperties, NotifierBase):
    """
    ...
    def __init__(self, args=Arguments()):
        ...
        HasCcpNmrProperties.__init__(self)
        ...
        if self.args.skipUserPreferences:
            ...
            self.preferences = Preferences(userPreferences=False)
        else:
            sys.stderr.write('==> Getting user preferences\n')
            self.preferences = Preferences(userPreferences=True)
