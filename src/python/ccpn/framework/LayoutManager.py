...
class LayoutManager(CcpNmrJson):
    ...
    _warning = Unicode('This file will be automatically overwritten').tag(saveToJson=True)
    modules = List(default_value=[]).tag(saveToJson=True)  # list of (moduleName, moduleClassName) tuples
    ...
    def _updateSettings(self):
        """Update the modules/layoutState to current values
        """
