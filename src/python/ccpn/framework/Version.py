...
__dateModified__ = "$dateModified: 2024-03-21 10:16:58 +0000 (Thu, March 21, 2024) $"
...
_previousApplicationVersion = VersionString('3.2.2.1')
applicationVersion = VersionString('3.2.3')
_lastApplicationVersion = VersionString('3.2.3')  # hide any messages beyond this point
revision = '3'
