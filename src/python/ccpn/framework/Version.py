...
__dateModified__ = "$dateModified: 2024-09-06 10:38:48 +0100 (Fri, September 06, 2024) $"
...
_previousApplicationVersion = VersionString('3.2.5')
applicationVersion = VersionString('3.2.6')
