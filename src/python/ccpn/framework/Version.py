...
__dateModified__ = "$dateModified: 2024-01-04 17:07:56 +0000 (Thu, January 04, 2024) $"
...
_previousApplicationVersion = VersionString('3.2.0.2')
applicationVersion = VersionString('3.2.1')
_lastApplicationVersion = VersionString('3.2.1')  # hide any messages beyond this point
revision = '3'
