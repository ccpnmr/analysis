...
__dateModified__ = "$dateModified: 2024-10-30 10:26:44 +0000 (Wed, October 30, 2024) $"
...
_previousApplicationVersion = VersionString('3.2.8')
applicationVersion = VersionString('3.2.9')
