...
__dateModified__ = "$dateModified: 2025-10-22 11:40:58 +0100 (Wed, October 22, 2025) $"
...
_previousApplicationVersion = VersionString('3.3.3')
applicationVersion = VersionString('3.3.4')
