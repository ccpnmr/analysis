...
__dateModified__ = "$dateModified: 2024-03-20 14:28:45 +0000 (Wed, March 20, 2024) $"
...
_previousApplicationVersion = VersionString('3.2.2')
applicationVersion = VersionString('3.2.2.1')
_lastApplicationVersion = VersionString('3.2.2.1')  # hide any messages beyond this point
revision = '3'
