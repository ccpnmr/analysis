...
__dateModified__ = "$dateModified: 2025-07-30 18:12:23 +0100 (Wed, July 30, 2025) $"
...
_previousApplicationVersion = VersionString('3.3.2.2')
applicationVersion = VersionString('3.3.2.3')
