...
class NefDataLoader(DataLoaderABC):
    ...
    def __init__(self, path):
        ...
        self._nefImporter = None # A CcpnNefImporter instance
    ...
    def nefImporter(self) -> CcpnNefImporter:
        """:return a CcnNefImporter instance loaded with contents of self.path
        """
        if self._nefImporter is None:
            self._nefImporter = self._getNefImporter()
        return self._nefImporter

    def _getNefImporter(self) -> CcpnNefImporter:
        """Helper function to get and load the file into a CcnNefImporter
        """
        _nefImporter = CcpnNefImporter()
