...
class SeriesAnalysisABC(ABC):
    ...
    def newDataTableFromSpectrumGroup(spectrumGroup:SpectrumGroup, seriesTableType:str,
                                      thePeakProperty:str, dataTableName:str=None,
        ...
        :param peakListIndex: int, peakList to use. Default: last created
        :param kwargs:
        :return:
        """
    ...
    def _setRestoringMetadata(dataTable, seriesFrame, spectrumGroup):
        ...
        dataTable.setMetadata(sv._peakPidHeaders, seriesFrame._peakPidHeaders)
    ...
    def _restoreDataTableData(self, dataTable):
        ...
        _peakPidHeaders = dataTable.metadata.get(sv._peakPidHeaders, SeriesFrameBC._peakPidHeaders)
        data = dataTable.data
        if spectrumGroup and data is not None:
            ...
            data._peakPidHeaders = _peakPidHeaders
