...
# User specifies a chemical shift list (CSL)
...
# set axis codes for new peak list (HN)
...
for residue in csl
    ...
    if have H and N atoms
       #  create an NH peak in the peak list using the CS in the csl
       create peak in peaklist