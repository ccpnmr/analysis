"""
This is the Pre-alpha BMRB Chemical Shift List Importer from NMR-STAR v3.1.
This can be used as a basis for a macro to generate a peak list from chemical shifts.
