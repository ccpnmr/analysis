...
class AutoGeneratedGuiPipeDemo(AutoGeneratedGuiPipe):
  ...
  preferredPipe = True
  params = [{'variable': 'demoPulldownList',
             'value': ('spectrum1', 'Slspectrum2'),
  ...
  def __init__(self, name=pipeName, parent=None, project=None,  **kw):
    ...
    AutoGeneratedGuiPipe.__init__(self, parent=parent, name=name, project=project,  **kw)

    print('AUTO GUI: ', self.widgetsState)
