...
def generateWidget(objMethod, Container=QWidget):
      ...
      if isinstance(param['value'], str):
        ...
        if isinstance(param['value'][0], str):
          ...
          if isinstance(param['value'][0][1], bool):
            ...
            rb.buttonGroup.buttonClicked[QtGui.QAbstractButton].connect(partial(selectedRadioButton, param=param,objMethod=objMethod))
