"""The file contains the Gui parts of the SpectrumDisplayModule
...
class GuiSpectrumDisplay(CcpnModule):
    ...
    def restoreSpectrumState(self, discard=False):
        ...
        return self.mainWindow.moduleArea.restoreModuleState(_layout=_layoutDict, module=self,
                                                             discard=discard)
        ...
        for spectrumView in self._loopOverSpectrumViews():
            ...
            with spectrum.blankNotifications():
                with undoStack() as addUndo:
                    ...
                    addUndo(undo=self._lowerContourBase,
                            redo=self._raiseContourBase
                            )
        ...
        for spectrumView in self._loopOverSpectrumViews():
            ...
            with spectrum.blankNotifications():
                with undoStack() as addUndo:
                    ...
                    addUndo(undo=self._raiseContourBase,
                            redo=self._lowerContourBase
                            )
