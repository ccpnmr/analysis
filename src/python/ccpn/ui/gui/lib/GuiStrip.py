...
from ccpn.ui.gui.guiSettings import getColours, CCPNGLWIDGET_HEXHIGHLIGHT, CCPNGLWIDGET_HEXFOREGROUND, _styleRed
...
class GuiStrip(Frame):
    ...
    def _resize(self):
        ...
        """
        # MUST BE SUBCLASSED
        raise NotImplementedError(f"Code error: {self.__class__.__name__}._resize function not implemented")
