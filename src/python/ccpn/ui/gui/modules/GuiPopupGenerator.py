...
class PopupGenerator(QtGui.QDialog, Base):
  ...
  def createPopupFromJson(self, jsonFile):
    ...
    pythonFile.write('from ccpn.ui.gui.widgets.ColourDialog import ColourDialog\n')
    pythonFile.write('from ccpn.ui.gui.widgets.DoubleSpinbox import DoubleSpinbox\n')
    pythonFile.write('from ccpn.ui.gui.widgets.Label import Label\n')
    pythonFile.write('from ccpn.ui.gui.widgets.LineEdit import LineEdit\n')
  ...
  def renderPopup(self):
    ...
    # copyfile(pythonFile, '/Users/simon1/PycharmProjects/CCPN_V3/trunk/ccpnv3/python/ccpn.ui.gui/modules/%s.py' % self.popupNameBox.text() )
    # package = 'ccpn.ui.gui.modules.'+self.popupNameBox.text()
    # print(package)
