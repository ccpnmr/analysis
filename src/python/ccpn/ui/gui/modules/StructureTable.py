...
__dateModified__ = "$dateModified: 2024-09-11 11:39:52 +0100 (Wed, September 11, 2024) $"
...
class StructureTableModule(CcpnTableModule):
    ...
    def __init__(self, mainWindow=None, name='StructureEnsemble Table',
...
class StructureTableFrame(_CoreTableFrameABC):
    ...
    def _cleanupWidget(self):
        if self._ensembleNotifier:
            self._ensembleNotifier.unRegisterNotifier()
