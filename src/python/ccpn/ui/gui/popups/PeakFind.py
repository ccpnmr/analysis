...
class PeakFindPopup(QtGui.QDialog, Base):
  ...
  def _updateContents(self):
    ...
    for ii in range(self.peakList.spectrum.dimensionCount):
      ...
      dim1MinDoubleSpinBox.setValue(self.peakList.spectrum.aliasingLimits[ii][0][0])
      ...
      dim1MaxDoubleSpinBox.setMaximum(self.peakList.spectrum.aliasingLimits[ii][0][1])
      dim1MaxDoubleSpinBox.setValue(self.peakList.spectrum.aliasingLimits[ii][0][1])
...
class ExcludeRegions(QtGui.QWidget, Base):
  ...
  def _addRegion(self):
    ...
    for ii in range(self.peakList.spectrum.dimensionCount):
      ...
      dim1MinDoubleSpinBox.setMinimum(self.peakList.spectrum.aliasingLimits[ii][0][0])
      dim1MinDoubleSpinBox.setMaximum(self.peakList.spectrum.aliasingLimits[ii][0][1])
      dim1MinDoubleSpinBox.setValue(self.peakList.spectrum.aliasingLimits[ii][0][0])
      ...
      dim1MaxDoubleSpinBox.setMinimum(self.peakList.spectrum.aliasingLimits[ii][0][0])
      dim1MaxDoubleSpinBox.setMaximum(self.peakList.spectrum.aliasingLimits[ii][0][1])
      dim1MaxDoubleSpinBox.setValue(self.peakList.spectrum.aliasingLimits[ii][0][1])
