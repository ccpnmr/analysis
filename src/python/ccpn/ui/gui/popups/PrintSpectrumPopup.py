...
__dateModified__ = "$dateModified: 2024-03-13 16:43:40 +0000 (Wed, March 13, 2024) $"
...
class SelectSpectrumDisplayPopup(CcpnDialog):
    def __init__(self, parent=None, mainWindow=None, **kwds):
        CcpnDialog.__init__(self, parent, setLayout=True, windowTitle='Export to File', **kwds)
