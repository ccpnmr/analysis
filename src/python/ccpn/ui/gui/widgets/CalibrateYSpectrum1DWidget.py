...
class CalibrateY1DWidgets(Frame):
    def __init__(self, parent=None, mainWindow=None, strip=None, **kwds):
        ...
        if self.GLWidget:
            self.infiniteLine = self.GLWidget.addInfiniteLine(colour='highlight', movable=True, lineStyle='solid', orientation='h', lineWidth=2.0)
            self.originalPosInfiniteLine = self.GLWidget.addInfiniteLine(colour='highlight', movable=True, lineStyle='dashed', orientation='h', lineWidth=2.0)
