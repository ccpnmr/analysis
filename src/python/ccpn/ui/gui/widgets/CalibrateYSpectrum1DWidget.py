...
class CalibrateY1DWidgets(Frame):
    ...
    def __init__(self, parent=None, mainWindow=None, strip=None, enableClose=True, **kwds):
        ...
        if enableClose:
            ...
            # add a spacer to align the buttons to the left, should line up with X widget Apply button
    ...
    def _initLines(self):
        if self.mainWindow is not None:
            _val = self.current.cursorPosition[1]
    ...
    def _apply(self):
        with handleDialogApply(self) as error:
            ...
            with undoStackBlocking() as addUndoItem:
                ...
                spectra = [(specView, specView.spectrum) for specView in self.strip.spectrumViews if specView.isDisplayed]
