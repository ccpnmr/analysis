...
from ccpn.ui.gui.lib.MenuActions import _openItemNoteTable, _openItemChemicalShiftListTable, \
    _openItemIntegralListTable, _openItemMultipletListTable, _openItemNmrResidueTable, \
    _openItemPeakListTable, _openItemResidueTable, _openItemRestraintListTable, \
    _openItemSpectrumGroupDisplay, _openItemStructureEnsembleTable, \
    _openItemSpectrumDisplay, _openItemSampleDisplay
        ...
        SidebarTree('Project', usePidForName=False, klass=Project, closed=False, children=[
            ...
            SidebarTree('NmrChains', closed=True, children=[
                ...
                SidebarClassTreeItems(klass=NmrChain, rebuildOnRename='NmrChain-ClassTreeItems',
                                      ...
                                      menuAction=_openItemNmrResidueTable(position='left', relativeTo=None), isDraggable=True, children=[
            ...
            SidebarTree('Chains', closed=True, children=[
                ...
                SidebarClassTreeItems(klass=Chain, rebuildOnRename='Chain-ClassTreeItems',
                                      ...
                                      menuAction=_openItemResidueTable(position='bottom', relativeTo=None), isDraggable=True, children=[
