...
# 
#  Current package api
import ccpncore.api.cambridge.Dangle
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.cambridge.Dangle.DangleChain
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.cambridge.Dangle.DangleResidue
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.cambridge.Dangle.DangleStore
  contentMap = {}
  currentMap['content'] = contentMap
