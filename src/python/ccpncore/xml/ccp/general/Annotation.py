...
# 
#  Current package api
import ccpncore.api.ccp.general.Annotation
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Annotation.Annotation
  contentMap = {}
  ...
  aList = ['description', 'details', 'name', 'path']
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Annotation.AnnotationStore
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpncore.api.ccp.general.Annotation.MolFeature
  contentMap = {}
  currentMap['content'] = contentMap
