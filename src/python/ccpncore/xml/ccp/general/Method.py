...
Autogenerated by PyXmlMapWrite on Sat Apr 16 11:53:01 2016
  from data model element ccp.general.Method
...
# 
#  Current package api
import ccpncore.api.ccp.general.Method
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Method.Method
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute Method._ID
  ...
  aList = ['parameters', 'instrument', 'columns', 'citations', 'applicationData']
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Method.MethodStore
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MethodStore._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute MethodStore._lastId
  ...
  aList = ['name']
  currentMap['simpleAttrs'] = aList
  aList = ['software', 'methods', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpncore.api.ccp.general.Method.Parameter
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  aList = ['_ID', 'paramType', 'serial', 'unit']
  currentMap['headerAttrs'] = aList
  aList = ['name', 'value']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Method.Software
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute Software._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
