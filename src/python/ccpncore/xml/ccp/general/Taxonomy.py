...
# 
#  Current package api
import ccpncore.api.ccp.general.Taxonomy
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Taxonomy.NaturalSource
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Taxonomy.Taxonomy
  contentMap = {}
  currentMap['content'] = contentMap
