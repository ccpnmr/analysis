...
# 
#  Current package api
import ccpncore.api.ccp.general.Template
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.general.Template.AbstractProbability
  contentMap = {}
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.ccp.general.Template.MultiTypeValue
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  aList = ['_ID', 'booleanValue', 'floatValue', 'intValue']
  currentMap['headerAttrs'] = aList
  aList = ['textValue']
