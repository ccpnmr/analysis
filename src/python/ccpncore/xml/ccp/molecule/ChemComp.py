...
Autogenerated by PyXmlMapWrite on Sat Apr 16 11:53:01 2016
  from data model element ccp.molecule.ChemComp
...
# 
#  Current package api
import ccpncore.api.ccp.molecule.ChemComp
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.AbstractChemAtom
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute AbstractChemAtom._ID
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.AtomSysName
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute AtomSysName._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'atomName', 'atomSubType']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemAngle
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemAngle._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemAtomSet
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemAtomSet._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'distCorr', 'isEquivalent', 'isProchiral', 'name', 'subType']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemBond
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemBond._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemComp
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemComp._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute ChemComp._lastId
  ...
  aList = ['_ID', '_lastId', 'beilsteinCode', 'casRegCode', 'ccpCode', 'code3Letter', 'createdBy', 'guid', 'hasStdChirality', 'isModifiable', 'lastUnlockedBy', 'merckCode', 'molType', 'sigmaAldrichCode']
  currentMap['headerAttrs'] = aList
  aList = ['baseGlycoCtCode', 'commonNames', 'details', 'keywords', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['stereochemistries', 'namingSystems', 'linkEnds', 'chemTorsions', 'chemCompVars', 'chemBonds', 'chemAtoms', 'chemAtomSets', 'chemAngles', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemCompSysName
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemCompSysName._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemCompVar
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemCompVar._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'formalCharge', 'isAromatic', 'isDefaultVar', 'isParamagnetic', 'linking']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemTorsion
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemTorsion._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemTorsionSysName
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemTorsionSysName._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.LinkEnd
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute LinkEnd._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.NamingSystem
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute NamingSystem._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['optLinks'] = aList
  aList = ['chemTorsionSysNames', 'chemCompSysNames', 'atomSysNames', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.Stereochemistry
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute Stereochemistry._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'serial', 'stereoClass', 'value']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['eType'] = 'cplx'
  currentMap['fromParent'] = 'chemAtoms'
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.ChemAtom
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ChemAtom._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'chirality', 'elementSymbol', 'name', 'nuclGroupType', 'subType', 'waterExchangeable']
  currentMap['headerAttrs'] = aList
  aList = ['shortVegaType', 'boundLinkEnds', 'chemAngles', 'chemBonds', 'chemCompVars', 'chemTorsions', 'coreStereochemistries', 'remoteLinkEnds', 'stereochemistries']
  currentMap['simpleAttrs'] = aList
  aList = ['chemAtomSet']
  currentMap['optLinks'] = aList
  aList = ['applicationData']
  ...
  currentMap['eType'] = 'cplx'
  currentMap['fromParent'] = 'chemAtoms'
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.LinkAtom
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute LinkAtom._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'name', 'subType']
  currentMap['headerAttrs'] = aList
  aList = ['boundLinkEnd', 'chemAngles', 'chemBonds', 'chemCompVars', 'chemTorsions', 'coreStereochemistries', 'remoteLinkEnd', 'stereochemistries']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['fromParent'] = 'chemComps'
  currentMap['isTop'] = True
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.StdChemComp
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute StdChemComp._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute StdChemComp._lastId
  contentMap['_lastId'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-05-13:04:27_00001')
  ...
  aList = ['_ID', '_lastId', 'beilsteinCode', 'casRegCode', 'ccpCode', 'code1Letter', 'code3Letter', 'createdBy', 'guid', 'hasStdChirality', 'isModifiable', 'lastUnlockedBy', 'merckCode', 'molType', 'sigmaAldrichCode', 'stdChemCompCode']
  currentMap['headerAttrs'] = aList
  aList = ['baseGlycoCtCode', 'commonNames', 'details', 'keywords', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['stereochemistries', 'namingSystems', 'linkEnds', 'chemTorsions', 'chemCompVars', 'chemBonds', 'chemAtoms', 'chemAtomSets', 'chemAngles', 'applicationData']
  ...
  currentMap['fromParent'] = 'chemComps'
  currentMap['isTop'] = True
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemComp.NonStdChemComp
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute NonStdChemComp._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute NonStdChemComp._lastId
  contentMap['_lastId'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-05-13:04:27_00001')
  ...
  aList = ['_ID', '_lastId', 'beilsteinCode', 'casRegCode', 'ccpCode', 'code3Letter', 'createdBy', 'guid', 'hasStdChirality', 'isModifiable', 'lastUnlockedBy', 'merckCode', 'molType', 'sigmaAldrichCode', 'stdChemCompCode']
  currentMap['headerAttrs'] = aList
  aList = ['baseGlycoCtCode', 'commonNames', 'details', 'keywords', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['stereochemistries', 'namingSystems', 'linkEnds', 'chemTorsions', 'chemCompVars', 'chemBonds', 'chemAtoms', 'chemAtomSets', 'chemAngles', 'applicationData']
