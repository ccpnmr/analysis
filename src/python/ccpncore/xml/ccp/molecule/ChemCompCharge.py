...
# 
#  Current package api
import ccpncore.api.ccp.molecule.ChemCompCharge
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCharge.ChemAtomCharge
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCharge.ChemCompCharge
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCharge.ChemCompVarCharge
  contentMap = {}
  currentMap['content'] = contentMap
