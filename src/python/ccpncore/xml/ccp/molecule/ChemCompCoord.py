...
# 
#  Current package api
import ccpncore.api.ccp.molecule.ChemCompCoord
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCoord.ChemAtomCoord
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCoord.ChemCompCoord
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemCompCoord.ChemCompVarCoord
  contentMap = {}
  currentMap['content'] = contentMap
