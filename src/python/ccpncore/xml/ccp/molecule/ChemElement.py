...
# 
#  Current package api
import ccpncore.api.ccp.molecule.ChemElement
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemElement.ChemElement
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemElement.ChemElementStore
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.ChemElement.Isotope
  contentMap = {}
  currentMap['content'] = contentMap
