...
# 
#  Current package api
import ccpncore.api.ccp.molecule.Molecule
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.Alignment
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute Alignment._ID
  ...
  aList = ['_ID', 'alignLength', 'alignmentScore', 'dbRefAlignBegin', 'dbRefAlignEnd', 'homologyRatio', 'nIdentical', 'nPositive', 'serial']
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.MolResLink
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MolResLink._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.MolResLinkEnd
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MolResLinkEnd._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.MolResidue
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MolResidue._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute MolResidue.applicationData
  contentMap['applicationData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2006-09-14-18:48:27_00007')

  # Attribute MolResidue.code3Letter
  currentMap = {}
  contentMap['code3Letter'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_Fogh_2014-07-30-17:44:24_00001'] = currentMap
  loadMaps['MOLE.MolResidue.code3Letter'] = currentMap
  currentMap['tag'] = 'MOLE.MolResidue.code3Letter'
  currentMap['type'] = 'attr'
  currentMap['guid'] = 'www.ccpn.ac.uk_Fogh_2014-07-30-17:44:24_00001'
  ...
  aList = ['_ID', 'code3Letter', 'linking', 'seqCode', 'serial']
  currentMap['headerAttrs'] = aList
  aList = ['descriptor', 'seqInsertCode']
  currentMap['simpleAttrs'] = aList
  aList = ['molSeqFragment']
  currentMap['optLinks'] = aList
  aList = ['molResLinkEnds', 'chemComp', 'applicationData']
  currentMap['cplxAttrs'] = aList
  aList = ['molResLinkEnds']
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.MolSeqFragment
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MolSeqFragment._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['simpleAttrs'] = aList
  aList = ['naturalSource', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.Molecule
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute Molecule._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute Molecule._lastId
  ...
  aList = ['_ID', '_lastId', 'calcIsoelectricPoint', 'createdBy', 'guid', 'isFinalised', 'isModifiable', 'lastUnlockedBy', 'smilesType']
  currentMap['headerAttrs'] = aList
  aList = ['commonNames', 'details', 'fragmentDetails', 'functions', 'keywords', 'longName', 'mutationDetails', 'name', 'seqDetails', 'smiles']
  currentMap['simpleAttrs'] = aList
  aList = ['moleculeSysNames', 'molSeqFragments', 'molResidues', 'molResLinks', 'alignments', 'naturalSource', 'citations', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Molecule.MoleculeSysName
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute MoleculeSysName._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
