...
# 
#  Current package api
import ccpncore.api.ccp.molecule.Stereochemistry
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Stereochemistry.RefStereochemistry
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Stereochemistry.StereochemistryStore
  contentMap = {}
  currentMap['content'] = contentMap
