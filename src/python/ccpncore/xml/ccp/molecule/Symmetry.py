...
# 
#  Current package api
import ccpncore.api.ccp.molecule.Symmetry
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Symmetry.MolSystemSymmetrySet
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Symmetry.Segment
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.ccp.molecule.Symmetry.Symmetry
  contentMap = {}
  currentMap['content'] = contentMap
