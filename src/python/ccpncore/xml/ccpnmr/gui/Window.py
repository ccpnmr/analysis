...
# 
#  Current package api
import ccpncore.api.ccpnmr.gui.Window
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.ccpnmr.gui.Window.Window
  contentMap = {}
  ...
  currentMap['class'] = ccpncore.api.ccpnmr.gui.Window.WindowStore
  contentMap = {}
  currentMap['content'] = contentMap
