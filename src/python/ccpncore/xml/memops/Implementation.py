...
Autogenerated by PyXmlMapWrite on Sat Apr 16 11:53:00 2016
...
# 
#  Current package api
import ccpncore.api.memops.Implementation
...
def getGlobalMap(oldVersionStr=None):
  ...
  if versionMapping is None:
    ...
    import ccpncore.xml.ccp.general.DbRef
    ccpncore.xml.ccp.general.DbRef.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.ChemElement
    ccpncore.xml.ccp.molecule.ChemElement.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.KeywordDefinition
    ccpncore.xml.ccp.general.KeywordDefinition.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.Stereochemistry
    ccpncore.xml.ccp.molecule.Stereochemistry.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.DataLocation
    ccpncore.xml.ccp.general.DataLocation.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Taxonomy
    ccpncore.xml.ccp.general.Taxonomy.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Template
    ccpncore.xml.ccp.general.Template.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.NmrExpPrototype
    ccpncore.xml.ccp.nmr.NmrExpPrototype.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.ChemComp
    ccpncore.xml.ccp.molecule.ChemComp.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Affiliation
    ccpncore.xml.ccp.general.Affiliation.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.ChemCompCharge
    ccpncore.xml.ccp.molecule.ChemCompCharge.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.NmrReference
    ccpncore.xml.ccp.nmr.NmrReference.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.ChemCompCoord
    ccpncore.xml.ccp.molecule.ChemCompCoord.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.ChemCompLabel
    ccpncore.xml.ccp.molecule.ChemCompLabel.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Citation
    ccpncore.xml.ccp.general.Citation.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.Molecule
    ccpncore.xml.ccp.molecule.Molecule.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Instrument
    ccpncore.xml.ccp.general.Instrument.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.MolSystem
    ccpncore.xml.ccp.molecule.MolSystem.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Annotation
    ccpncore.xml.ccp.general.Annotation.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.LabeledMolecule
    ccpncore.xml.ccp.molecule.LabeledMolecule.makeMapping(versionMapping)

    import ccpncore.xml.ccp.general.Method
    ccpncore.xml.ccp.general.Method.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.Symmetry
    ccpncore.xml.ccp.molecule.Symmetry.makeMapping(versionMapping)

    import ccpncore.xml.ccp.lims.RefSampleComponent
    ccpncore.xml.ccp.lims.RefSampleComponent.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.Validation
    ccpncore.xml.ccp.molecule.Validation.makeMapping(versionMapping)

    import ccpncore.xml.molsim.AnnealProtocol
    ccpncore.xml.molsim.AnnealProtocol.makeMapping(versionMapping)

    import ccpncore.xml.ccp.lims.Sample
    ccpncore.xml.ccp.lims.Sample.makeMapping(versionMapping)

    import ccpncore.xml.ccp.molecule.MolStructure
    ccpncore.xml.ccp.molecule.MolStructure.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.Nmr
    ccpncore.xml.ccp.nmr.Nmr.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.NmrEntry
    ccpncore.xml.ccp.nmr.NmrEntry.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.NmrConstraint
    ccpncore.xml.ccp.nmr.NmrConstraint.makeMapping(versionMapping)

    import ccpncore.xml.ccpnmr.gui.Window
    ccpncore.xml.ccpnmr.gui.Window.makeMapping(versionMapping)

    import ccpncore.xml.ccp.nmr.NmrCalc
    ccpncore.xml.ccp.nmr.NmrCalc.makeMapping(versionMapping)

    import ccpncore.xml.utrecht.Haddock
    ccpncore.xml.utrecht.Haddock.makeMapping(versionMapping)

    import ccpncore.xml.cambridge.Dangle
    ccpncore.xml.cambridge.Dangle.makeMapping(versionMapping)

    import ccpncore.xml.ccpnmr.gui.Task
    ccpncore.xml.ccpnmr.gui.Task.makeMapping(versionMapping)

    import ccpncore.xml.cambridge.WmsProtocol
    ccpncore.xml.cambridge.WmsProtocol.makeMapping(versionMapping)
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.memops.Implementation.ComplexDataType
  contentMap = {}
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.MemopsDataTypeObject
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.ApplicationData
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.SymmTracelessMatrix
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.Url
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.AppDataString
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.AppDataBoolean
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.AppDataFloat
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.AppDataInt
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.MemopsObject
  contentMap = {}
  currentMap['content'] = contentMap
  # End of MemopsObject
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.ImplementationObject
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.DataObject
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.memops.Implementation.PackageLocator
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.memops.Implementation.Repository
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['eType'] = 'cplx'
  currentMap['class'] = ccpncore.api.memops.Implementation.MemopsRoot
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.memops.Implementation.TopObject
  contentMap = {}
  currentMap['content'] = contentMap
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  # check for topObject
  if (isinstance(topObject, ccpncore.api.memops.Implementation.MemopsRoot)):
    isImplementation = True
  elif (isinstance(topObject, ccpncore.api.memops.Implementation.TopObject)):
  ...
  strapp('%s<%s release="%s" packageGuid="%s" time="%s" originator="%s">\n' % (indent, '_StorageUnit', release, guid, date, originator))
  strapp('\n')
    ...
    if (val is startObj):
      ...
      if (typ == 'simple'):
        ...
        for ii in reversed(range(len(keys))):
          key = keys[ii]
          stack.append(key)
          if ((isinstance(key, ccpncore.api.memops.Implementation.MemopsObject) or isinstance(key, ccpncore.api.memops.Implementation.MemopsDataTypeObject))):
...
def loadFromStream(stream, topObjId=None, topObject=None, partialLoad=False):
  ...
  if (topObject is not None):
    # check for topObject
    if (not ((isinstance(topObject, ccpncore.api.memops.Implementation.MemopsRoot) or isinstance(topObject, ccpncore.api.memops.Implementation.TopObject)))):
  ...
  try:
            ...
            if (('cplx' == typ or 'class' == typ)):
              ...
              if ('class' == typ):
                ...
                if (topObjectKey is None):
                  ...
                  elif (isinstance(topObject, ccpncore.api.memops.Implementation.MemopsRoot)):
                    # IF BLOCK 108
                  ...
                  result = obj
                  if (isinstance(obj, ccpncore.api.memops.Implementation.MemopsRoot)):
                    memopsRoot = obj
                  else:
        ...
        if (objStack):
          ...
          if ('simple' == typ):
            ...
            if ('delay' == proc):
              ...
              if (isinstance(containerObj, ccpncore.api.memops.Implementation.MemopsObject)):
                dictid = containerObj
              else:
    ...
    if (needCompatibility):
      ...
      from ccpncore.memops.format.compatibility import Converters1
    ...
    if (not (hasattr(memopsRoot, '_isUpgraded') and memopsRoot._isUpgraded)):
...
def linkChildData(delayDataDict, topObj, mapping, linkTopToParent=False, doOutOfPackage=False):
  ...
  if (doOutOfPackage):
    ...
    # IF BLOCK 303
    if (isinstance(topObj, ccpncore.api.memops.Implementation.MemopsRoot)):
