...
# 
#  Current package api
import ccpncore.api.molsim.AnnealProtocol
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.AnnealProtocol
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute AnnealProtocol._ID
  ...
  aList = ['energyTerms', 'annealStages', 'applicationData']
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.AnnealProtocolStore
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute AnnealProtocolStore._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute AnnealProtocolStore._lastId
  ...
  aList = ['name']
  currentMap['simpleAttrs'] = aList
  aList = ['refPotentialTerms', 'annealProtocols', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.AnnealStage
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute AnnealStage._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'finalTemp', 'function', 'initialTemp', 'numSteps', 'numSubSteps', 'serial', 'timeStep', 'timeStepScaling']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.EnergyTerm
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['simpleAttrs'] = aList
  aList = ['potentialScales', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.PotentialScale
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute PotentialScale._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'finalScale', 'function', 'initialScale']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.RefPotentialTerm
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute RefPotentialTerm._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['simpleAttrs'] = aList
  aList = ['refTermParameters', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.molsim.AnnealProtocol.RefTermParameter
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute RefTermParameter._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
