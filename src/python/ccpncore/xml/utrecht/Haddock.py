...
# 
#  Current package api
import ccpncore.api.utrecht.Haddock
...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.Chain
  contentMap = {}
  ...
  aList = ['residues', 'chain', 'applicationData']
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.EnergyTermParameter
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.HaddockEnergyTerm
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute HaddockEnergyTerm._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  currentMap['simpleAttrs'] = aList
  aList = ['energyTermParameters', 'energyTerm', 'constraintList', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['objkey'] = 'code'
  currentMap['class'] = ccpncore.api.utrecht.Haddock.HaddockPartner
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute HaddockPartner._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
  ...
  aList = ['_ID', 'airUpperDistanceLimit', 'autoHistidinePstate', 'code', 'forceFieldCode', 'isDna', 'semiFlexMode']
  currentMap['headerAttrs'] = aList
  aList = ['fileNames']
  currentMap['simpleAttrs'] = aList
  aList = ['chains', 'structureEnsemble', 'molSystem', 'applicationData']
  currentMap['cplxAttrs'] = aList
  aList = ['chains']
  currentMap['children'] = aList
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.HaddockProject
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute HaddockProject._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')

  # Attribute HaddockProject._lastId
  ...
  currentMap['simpleAttrs'] = aList
  aList = ['runs', 'haddockPartners', 'applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.Residue
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  aList = ['_ID', 'flexibility', 'haddockSeqId', 'interaction']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.Run
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpncore.api.utrecht.Haddock.ScoringWeight
  contentMap = {}
  currentMap['content'] = contentMap

  # Attribute ScoringWeight._ID
  contentMap['_ID'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2014-03-03-16:24:15_00001')
