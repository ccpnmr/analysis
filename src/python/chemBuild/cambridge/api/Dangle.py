...
class DangleChain(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    dangleResidues = list(dataDict.get('dangleResidues').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('dangleResidues').values())
    for value in values:
  ...
  def findAllDangleResidues(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('dangleResidues').values())
  ...
  def getDangleResidues(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('dangleResidues').values())
...
class serves as TopObject. 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    dangleChains = list(dataDict.get('dangleChains').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('dangleChains').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllDangleChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('dangleChains').values())
      result = set(currentValues)
  ...
  def getDangleChains(self):
    ...
    tempVar = list(dataDict.get('dangleChains').values())
    result = frozenset(tempVar)
    return result
