...
class Project(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    projectVersions = list(dataDict.get('projectVersions').values())
    ...
    rawFiles = list(dataDict.get('rawFiles').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('projectVersions').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('rawFiles').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllProjectVersions(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('projectVersions').values())
  ...
  def findAllRawFiles(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('rawFiles').values())
      result = set(currentValues)
  ...
  def getProjectVersions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('projectVersions').values())
  ...
  def getRawFiles(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('rawFiles').values())
    result = frozenset(tempVar)
    return result
...
class WmsSegment(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tasks = list(dataDict.get('tasks').values())
    for task in tasks:
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('tasks').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllTasks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('tasks').values())
      result = set(currentValues)
  ...
  def getTasks(self):
    ...
    tempVar = list(dataDict.get('tasks').values())
    result = frozenset(tempVar)
    return result
