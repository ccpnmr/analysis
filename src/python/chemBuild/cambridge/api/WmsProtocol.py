...
class ProtocolInterface(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    interfaceLabels = list(dataDict.get('interfaceLabels').values())
    ...
    interfaceParameters = list(dataDict.get('interfaceParameters').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('interfaceLabels').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('interfaceParameters').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllInterfaceLabels(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('interfaceLabels').values())
  ...
  def findAllInterfaceParameters(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('interfaceParameters').values())
      result = set(currentValues)
  ...
  def getInterfaceLabels(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('interfaceLabels').values())
  ...
  def getInterfaceParameters(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('interfaceParameters').values())
    result = frozenset(tempVar)
    return result
...
class ProtocolService(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    protocolAccesss = list(dataDict.get('protocolAccesss').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('protocolAccesss').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllProtocolAccesss(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('protocolAccesss').values())
      result = set(currentValues)
  ...
  def getProtocolAccesss(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('protocolAccesss').values())
    result = frozenset(tempVar)
    return result
...
class WmsProtocol(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    protocolInterfaces = list(dataDict.get('protocolInterfaces').values())
    ...
    protocolParameters = list(dataDict.get('protocolParameters').values())
    ...
    protocolServices = list(dataDict.get('protocolServices').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('protocolInterfaces').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('protocolParameters').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('protocolServices').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllProtocolInterfaces(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('protocolInterfaces').values())
      result = set(currentValues)
  ...
  def findAllProtocolParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('protocolParameters').values())
      result = set(currentValues)
  ...
  def findAllProtocolServices(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('protocolServices').values())
      result = set(currentValues)
  ...
  def getProtocolInterfaces(self):
    ...
    tempVar = list(dataDict.get('protocolInterfaces').values())
    result = frozenset(tempVar)
    return result
  ...
  def getProtocolParameters(self):
    ...
    tempVar = list(dataDict.get('protocolParameters').values())
    result = frozenset(tempVar)
    return result
  ...
  def getProtocolServices(self):
    ...
    tempVar = list(dataDict.get('protocolServices').values())
    result = frozenset(tempVar)
    return result
...
class InterfaceParameter(InterfaceObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    enumValues = list(dataDict.get('enumValues').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('enumValues').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllEnumValues(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('enumValues').values())
      result = set(currentValues)
  ...
  def getEnumValues(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('enumValues').values())
    result = frozenset(tempVar)
    return result
