...
class AffiliationStore(memops.api.Implementation.TopObject):
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('organisations').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('persons').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllOrganisations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('organisations').values())
  ...
  def findAllPersons(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('persons').values())
      result = set(currentValues)
  ...
  def getOrganisations(self):
    ...
    tempVar = list(dataDict.get('organisations').values())
  ...
  def getPersons(self):
    ...
    tempVar = list(dataDict.get('persons').values())
    result = frozenset(tempVar)
    return result
...
class Organisation(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    groups = list(dataDict.get('groups').values())
    for group in groups:
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('groups').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllGroups(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('groups').values())
      result = set(currentValues)
  ...
  def getGroups(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('groups').values())
    result = frozenset(tempVar)
    return result
...
class Person(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('citationStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    tobjList = list(root.__dict__.get('crystallizationStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    personInGroups = list(dataDict.get('personInGroups').values())
    for personInGroup in personInGroups:
      if (not (personInGroup in objsToBeDeleted)):
        objsToBeDeleted.add(personInGroup)
        objsToBeChecked.append(personInGroup)
  ...
  def addUser(self, value):
    ...
    if (notIsReading):
      ...
      if (value.__dict__.get('person') is None):
        ...
        tobjList = list(root.__dict__.get('affiliationStores').values())
        for tobj in tobjList:
          if (not (tobj.__dict__.get('isLoaded'))):
            tobj.load()
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('personInGroups').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllPersonInGroups(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('personInGroups').values())
      result = set(currentValues)
  ...
  def getPersonInGroups(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('personInGroups').values())
    result = frozenset(tempVar)
    return result
