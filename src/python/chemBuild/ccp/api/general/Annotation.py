...
class AnnotationStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    annotations = list(dataDict.get('annotations').values())
    ...
    molFeatures = list(dataDict.get('molFeatures').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('annotations').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molFeatures').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAnnotations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('annotations').values())
      result = set(currentValues)
  ...
  def findAllMolFeatures(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molFeatures').values())
      result = set(currentValues)
  ...
  def getAnnotations(self):
    ...
    tempVar = list(dataDict.get('annotations').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolFeatures(self):
    ...
    tempVar = list(dataDict.get('molFeatures').values())
    result = frozenset(tempVar)
    return result
