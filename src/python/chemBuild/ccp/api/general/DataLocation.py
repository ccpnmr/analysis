...
class DataLocationStore(memops.api.Implementation.TopObject):
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('dataStores').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('dataUrls').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllDataStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('dataStores').values())
  ...
  def findAllDataUrls(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('dataUrls').values())
      result = set(currentValues)
  ...
  def getDataStores(self):
    ...
    tempVar = list(dataDict.get('dataStores').values())
  ...
  def getDataUrls(self):
    ...
    tempVar = list(dataDict.get('dataUrls').values())
    result = frozenset(tempVar)
    return result
...
header size refers to the header of the entire dataasource.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    componentShapes = list(dataDict.get('componentShapes').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('componentShapes').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllComponentShapes(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('componentShapes').values())
      result = set(currentValues)
  ...
  def getComponentShapes(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('componentShapes').values())
    result = frozenset(tempVar)
    return result
