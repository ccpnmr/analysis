...
class InstrumentStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    instruments = list(dataDict.get('instruments').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('instruments').values())
    for value in values:
  ...
  def findAllInstruments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('instruments').values())
  ...
  def getInstruments(self):
    ...
    tempVar = list(dataDict.get('instruments').values())
