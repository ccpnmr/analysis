...
program or standard). 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    keywordDefinitions = list(dataDict.get('keywordDefinitions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('keywordDefinitions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllKeywordDefinitions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('keywordDefinitions').values())
  ...
  def getKeywordDefinitions(self):
    ...
    tempVar = list(dataDict.get('keywordDefinitions').values())
    result = frozenset(tempVar)
    return result
