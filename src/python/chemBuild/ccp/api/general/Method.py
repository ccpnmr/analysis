  ...
  def addColumn(self, value):
    ...
    if (notIsReading):
      ...
      if (value.__dict__.get('loadingMethod') is None):
        ...
        tobjList = list(root.__dict__.get('methodStores').values())
        for tobj in tobjList:
          if (not (tobj.__dict__.get('isLoaded'))):
            tobj.load()
...
class MethodStore(memops.api.Implementation.TopObject):
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('methods').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('software').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllMethods(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('methods').values())
      result = set(currentValues)
  ...
  def findAllSoftware(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('software').values())
      result = set(currentValues)
  ...
  def getMethods(self):
    ...
    tempVar = list(dataDict.get('methods').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSoftware(self):
    ...
    tempVar = list(dataDict.get('software').values())
    result = frozenset(tempVar)
    return result
