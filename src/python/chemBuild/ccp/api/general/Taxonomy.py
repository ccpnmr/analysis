...
class Taxonomy(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    naturalSources = list(dataDict.get('naturalSources').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('naturalSources').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllNaturalSources(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('naturalSources').values())
      result = set(currentValues)
  ...
  def getNaturalSources(self):
    ...
    tempVar = list(dataDict.get('naturalSources').values())
    result = frozenset(tempVar)
    return result
