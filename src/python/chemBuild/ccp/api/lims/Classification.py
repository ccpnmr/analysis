...
class Classification(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    experimentTypes = list(dataDict.get('experimentTypes').values())
    ...
    hazardPhrases = list(dataDict.get('hazardPhrases').values())
    ...
    holderCategorys = list(dataDict.get('holderCategorys').values())
    ...
    instrumentTypes = list(dataDict.get('instrumentTypes').values())
    ...
    sampleCategories = list(dataDict.get('sampleCategories').values())
    ...
    sampleComponentCategory = list(dataDict.get('sampleComponentCategory').values())
    ...
    targetScoreboards = list(dataDict.get('targetScoreboards').values())
    ...
    targetStatus_s = list(dataDict.get('targetStatus').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('experimentTypes').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('hazardPhrases').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('holderCategorys').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('instrumentTypes').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('sampleCategories').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('sampleComponentCategory').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('targetScoreboards').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('targetStatus').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllExperimentTypes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('experimentTypes').values())
  ...
  def findAllHazardPhrases(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('hazardPhrases').values())
      result = set(currentValues)
  ...
  def findAllHolderCategorys(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('holderCategorys').values())
      result = set(currentValues)
  ...
  def findAllInstrumentTypes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('instrumentTypes').values())
      result = set(currentValues)
  ...
  def findAllSampleCategories(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('sampleCategories').values())
      result = set(currentValues)
  ...
  def findAllSampleComponentCategory(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('sampleComponentCategory').values())
      result = set(currentValues)
  ...
  def findAllTargetScoreboards(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('targetScoreboards').values())
      result = set(currentValues)
  ...
  def findAllTargetStatus(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('targetStatus').values())
      result = set(currentValues)
  ...
  def getExperimentTypes(self):
    ...
    tempVar = list(dataDict.get('experimentTypes').values())
  ...
  def getHazardPhrases(self):
    ...
    tempVar = list(dataDict.get('hazardPhrases').values())
    result = frozenset(tempVar)
    return result
  ...
  def getHolderCategorys(self):
    ...
    tempVar = list(dataDict.get('holderCategorys').values())
    result = frozenset(tempVar)
    return result
  ...
  def getInstrumentTypes(self):
    ...
    tempVar = list(dataDict.get('instrumentTypes').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSampleCategories(self):
    ...
    tempVar = list(dataDict.get('sampleCategories').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSampleComponentCategory(self):
    ...
    tempVar = list(dataDict.get('sampleComponentCategory').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTargetScoreboards(self):
    ...
    tempVar = list(dataDict.get('targetScoreboards').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTargetStatus(self):
    ...
    tempVar = list(dataDict.get('targetStatus').values())
    result = frozenset(tempVar)
    return result
...
caregories include buffering agent, salt, inhibitor,...
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    tobjList = list(root.__dict__.get('refSampleComponentStores').values())
...
organisations can have their own types.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('experimentStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    tobjList = list(root.__dict__.get('protocolStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
...
organisations can have their own categories.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('holderStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
...
specific to a particular organisation.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('instrumentStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
...
organisations can have their own categories.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('sampleStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
...
class TargetStatus(AbstractCategory):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('expBlueprintStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    tobjList = list(root.__dict__.get('targetStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
