...
class CrystallizationStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    dropAnnotations = list(dataDict.get('dropAnnotations').values())
    ...
    images = list(dataDict.get('images').values())
    for image in images:
    ...
    scoringSchemes = list(dataDict.get('scoringSchemes').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('dropAnnotations').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('images').values())
    for value in values:
      value.checkAllValid(complete)
    ...
    values = list(dataDict.get('scoringSchemes').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllDropAnnotations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('dropAnnotations').values())
  ...
  def findAllImages(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('images').values())
      result = set(currentValues)
  ...
  def findAllScoringSchemes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('scoringSchemes').values())
      result = set(currentValues)
  ...
  def getDropAnnotations(self):
    ...
    tempVar = list(dataDict.get('dropAnnotations').values())
  ...
  def getImages(self):
    ...
    tempVar = list(dataDict.get('images').values())
    result = frozenset(tempVar)
    return result
  ...
  def getScoringSchemes(self):
    ...
    tempVar = list(dataDict.get('scoringSchemes').values())
    result = frozenset(tempVar)
    return result
...
class ScoringScheme(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    scores = list(dataDict.get('scores').values())
    for score in scores:
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('scores').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllScores(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('scores').values())
      result = set(currentValues)
  ...
  def getScores(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('scores').values())
    result = frozenset(tempVar)
    return result
