...
of wish targets and non-polymer molecules.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    blueprintComponents = list(dataDict.get('blueprintComponents').values())
    ...
    blueprintDbRefs = list(dataDict.get('blueprintDbRefs').values())
    ...
    blueprintStatuses = list(dataDict.get('blueprintStatuses').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('blueprintComponents').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('blueprintDbRefs').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('blueprintStatuses').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllBlueprintComponents(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('blueprintComponents').values())
      result = set(currentValues)
  ...
  def findAllBlueprintDbRefs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('blueprintDbRefs').values())
      result = set(currentValues)
  ...
  def findAllBlueprintStatuses(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('blueprintStatuses').values())
      result = set(currentValues)
  ...
  def getBlueprintComponents(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('blueprintComponents').values())
    result = frozenset(tempVar)
    return result
  ...
  def getBlueprintDbRefs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('blueprintDbRefs').values())
    result = frozenset(tempVar)
    return result
  ...
  def getBlueprintStatuses(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('blueprintStatuses').values())
    result = frozenset(tempVar)
    return result
...
class ExpBlueprintStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    expBlueprints = list(dataDict.get('expBlueprints').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('expBlueprints').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllExpBlueprints(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('expBlueprints').values())
      result = set(currentValues)
  ...
  def getExpBlueprints(self):
    ...
    tempVar = list(dataDict.get('expBlueprints').values())
    result = frozenset(tempVar)
    return result
