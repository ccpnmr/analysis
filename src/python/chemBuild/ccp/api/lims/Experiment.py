...
class Experiment(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    outputSamples = list(dataDict.get('outputSamples').values())
    ...
    sampleIos = list(dataDict.get('sampleIos').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('outputSamples').values())
    for value in values:
    ...
    values = list(dataDict.get('sampleIos').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllOutputSamples(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('outputSamples').values())
      result = set(currentValues)
  ...
  def findAllSampleIos(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('sampleIos').values())
      result = set(currentValues)
  ...
  def getOutputSamples(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('outputSamples').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSampleIos(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('sampleIos').values())
    result = frozenset(tempVar)
    return result
...
class ExperimentStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    experimentGroups = list(dataDict.get('experimentGroups').values())
    ...
    experiments = list(dataDict.get('experiments').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('experimentGroups').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('experiments').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllExperimentGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('experimentGroups').values())
      result = set(currentValues)
  ...
  def findAllExperiments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('experiments').values())
      result = set(currentValues)
  ...
  def getExperimentGroups(self):
    ...
    tempVar = list(dataDict.get('experimentGroups').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExperiments(self):
    ...
    tempVar = list(dataDict.get('experiments').values())
    result = frozenset(tempVar)
    return result
