...
group holder together.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    holderLocations = list(dataDict.get('holderLocations').values())
    ...
    refSamplePositions = list(dataDict.get('refSamplePositions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('holderLocations').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refSamplePositions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllHolderLocations(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('holderLocations').values())
      result = set(currentValues)
  ...
  def findAllRefSamplePositions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refSamplePositions').values())
      result = set(currentValues)
  ...
  def getHolderLocations(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('holderLocations').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefSamplePositions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refSamplePositions').values())
    result = frozenset(tempVar)
    return result
...
class HolderStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    holderTypes = list(dataDict.get('holderTypes').values())
    ...
    holders = list(dataDict.get('holders').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('holderTypes').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('holders').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllHolderTypes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('holderTypes').values())
      result = set(currentValues)
  ...
  def findAllHolders(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('holders').values())
      result = set(currentValues)
  ...
  def getHolderTypes(self):
    ...
    tempVar = list(dataDict.get('holderTypes').values())
    result = frozenset(tempVar)
    return result
  ...
  def getHolders(self):
    ...
    tempVar = list(dataDict.get('holders').values())
    result = frozenset(tempVar)
    return result
...
rather than A1.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    holderTypePositions = list(dataDict.get('holderTypePositions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('holderTypePositions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllHolderTypePositions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('holderTypePositions').values())
      result = set(currentValues)
  ...
  def getHolderTypePositions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('holderTypePositions').values())
    result = frozenset(tempVar)
    return result
