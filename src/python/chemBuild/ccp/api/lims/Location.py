...
class LocationStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    locations = list(dataDict.get('locations').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('locations').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllLocations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('locations').values())
      result = set(currentValues)
  ...
  def getLocations(self):
    ...
    tempVar = list(dataDict.get('locations').values())
    result = frozenset(tempVar)
    return result
