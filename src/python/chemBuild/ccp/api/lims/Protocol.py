...
class Procedure(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    steps = list(dataDict.get('steps').values())
    for step in steps:
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('steps').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllSteps(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('steps').values())
      result = set(currentValues)
  ...
  def getSteps(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('steps').values())
    result = frozenset(tempVar)
    return result
...
that contain steps.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    parameterDefinitions = list(dataDict.get('parameterDefinitions').values())
    ...
    procedures = list(dataDict.get('procedures').values())
    for procedure in procedures:
      if (not (procedure in objsToBeDeleted)):
        objsToBeDeleted.add(procedure)
        objsToBeChecked.append(procedure)

    refInputSamples = list(dataDict.get('refInputSamples').values())
    ...
    refOutputSamples = list(dataDict.get('refOutputSamples').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('parameterDefinitions').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('procedures').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refInputSamples').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refOutputSamples').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllParameterDefinitions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('parameterDefinitions').values())
      result = set(currentValues)
  ...
  def findAllProcedures(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('procedures').values())
      result = set(currentValues)
  ...
  def findAllRefInputSamples(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refInputSamples').values())
      result = set(currentValues)
  ...
  def findAllRefOutputSamples(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refOutputSamples').values())
      result = set(currentValues)
  ...
  def getParameterDefinitions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('parameterDefinitions').values())
    result = frozenset(tempVar)
    return result
  ...
  def getProcedures(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('procedures').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefInputSamples(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refInputSamples').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefOutputSamples(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refOutputSamples').values())
    result = frozenset(tempVar)
    return result
...
class ProtocolStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    protocols = list(dataDict.get('protocols').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('protocols').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllProtocols(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('protocols').values())
      result = set(currentValues)
  ...
  def getProtocols(self):
    ...
    tempVar = list(dataDict.get('protocols').values())
    result = frozenset(tempVar)
    return result
