...
Cell, Substance and Composite.
  ...
  def findAllComponentDbRefs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('componentDbRefs').values())
      result = set(currentValues)
  ...
  def findAllLabels(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('labels').values())
      result = set(currentValues)
  ...
  def getComponentDbRefs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('componentDbRefs').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLabels(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('labels').values())
    result = frozenset(tempVar)
    return result
...
class RefSampleComponentStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    components = list(dataDict.get('components').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('components').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllComponents(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('components').values())
      result = set(currentValues)
  ...
  def getComponents(self):
    ...
    tempVar = list(dataDict.get('components').values())
    result = frozenset(tempVar)
    return result
...
as both are valid together.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    isotopeLabels = list(dataDict.get('isotopeLabels').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('isotopeLabels').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllIsotopeLabels(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('isotopeLabels').values())
      result = set(currentValues)
  ...
  def getIsotopeLabels(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('isotopeLabels').values())
    result = frozenset(tempVar)
    return result
...
so is lysozyme.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    componentDbRefs = list(dataDict.get('componentDbRefs').values())
    ...
    labels = list(dataDict.get('labels').values())
    for label in labels:
      if (not (label in objsToBeDeleted)):
        objsToBeDeleted.add(label)
        objsToBeChecked.append(label)

    molCompFeatures = list(dataDict.get('molCompFeatures').values())
    ...
    specificLabelGroups = list(dataDict.get('specificLabelGroups').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('componentDbRefs').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('labels').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molCompFeatures').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('specificLabelGroups').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllMolCompFeatures(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('molCompFeatures').values())
      result = set(currentValues)
  ...
  def findAllSpecificLabelGroups(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('specificLabelGroups').values())
      result = set(currentValues)
  ...
  def getMolCompFeatures(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('molCompFeatures').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSpecificLabelGroups(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('specificLabelGroups').values())
    result = frozenset(tempVar)
    return result
...
plasmids.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    elements = list(dataDict.get('elements').values())
    for element in elements:
      if (not (element in objsToBeDeleted)):
        objsToBeDeleted.add(element)
        objsToBeChecked.append(element)

    interactions = list(dataDict.get('interactions').values())
    for interaction in interactions:
      if (not (interaction in objsToBeDeleted)):
        objsToBeDeleted.add(interaction)
        objsToBeChecked.append(interaction)
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('elements').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('interactions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllElements(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('elements').values())
      result = set(currentValues)
  ...
  def findAllInteractions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('interactions').values())
      result = set(currentValues)
  ...
  def getElements(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('elements').values())
    result = frozenset(tempVar)
    return result
  ...
  def getInteractions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('interactions').values())
    result = frozenset(tempVar)
    return result
