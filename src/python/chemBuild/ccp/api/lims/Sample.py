...
class AbstractSample(memops.api.Implementation.DataObject):
  ...
  def findAllSampleComponents(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('sampleComponents').values())
      result = set(currentValues)
  ...
  def getSampleComponents(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('sampleComponents').values())
    result = frozenset(tempVar)
    return result
...
class SampleStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    objsToBeDeleted.add(self)
    abstractSamples = list(dataDict.get('abstractSamples').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('abstractSamples').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAbstractSamples(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('abstractSamples').values())
      result = set(currentValues)
  ...
  def getAbstractSamples(self):
    ...
    tempVar = list(dataDict.get('abstractSamples').values())
    result = frozenset(tempVar)
    return result
...
supplier and batch independant.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refSampleSources = list(dataDict.get('refSampleSources').values())
    ...
    sampleComponents = list(dataDict.get('sampleComponents').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('refSampleSources').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('sampleComponents').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllRefSampleSources(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refSampleSources').values())
      result = set(currentValues)
  ...
  def getRefSampleSources(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refSampleSources').values())
    result = frozenset(tempVar)
    return result
