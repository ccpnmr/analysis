...
class TargetStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    projects = list(dataDict.get('projects').values())
    for project in projects:
      if (not (project in objsToBeDeleted)):
        objsToBeDeleted.add(project)
        objsToBeChecked.append(project)

    targetGroups = list(dataDict.get('targetGroups').values())
    for targetGroup in targetGroups:
      if (not (targetGroup in objsToBeDeleted)):
        objsToBeDeleted.add(targetGroup)
        objsToBeChecked.append(targetGroup)

    targets = list(dataDict.get('targets').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('projects').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('targetGroups').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('targets').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllProjects(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('projects').values())
      result = set(currentValues)
  ...
  def findAllTargetGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('targetGroups').values())
      result = set(currentValues)
  ...
  def findAllTargets(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('targets').values())
      result = set(currentValues)
  ...
  def getProjects(self):
    ...
    tempVar = list(dataDict.get('projects').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTargetGroups(self):
    ...
    tempVar = list(dataDict.get('targetGroups').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTargets(self):
    ...
    tempVar = list(dataDict.get('targets').values())
    result = frozenset(tempVar)
    return result
