...
Atoms, Bonds etc. linked to do not form a consistent set. 
  ...
  def findAllChemAngles(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemAngles').values())
      result = set(currentValues)
  ...
  def findAllChemAtomSets(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemAtomSets').values())
      result = set(currentValues)
  ...
  def findAllChemAtoms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemAtoms').values())
      result = set(currentValues)
  ...
  def findAllChemBonds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemBonds').values())
      result = set(currentValues)
  ...
  def findAllChemCompVars(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemCompVars').values())
      result = set(currentValues)
  ...
  def findAllChemTorsions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemTorsions').values())
      result = set(currentValues)
  ...
  def findAllLinkEnds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('linkEnds').values())
      result = set(currentValues)
  ...
  def findAllNamingSystems(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('namingSystems').values())
      result = set(currentValues)
  ...
  def findAllStereochemistries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('stereochemistries').values())
      result = set(currentValues)
  ...
  def getChemAngles(self):
    ...
    tempVar = list(dataDict.get('chemAngles').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemAtomSets(self):
    ...
    tempVar = list(dataDict.get('chemAtomSets').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemAtoms(self):
    ...
    tempVar = list(dataDict.get('chemAtoms').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemBonds(self):
    ...
    tempVar = list(dataDict.get('chemBonds').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompVars(self):
    ...
    tempVar = list(dataDict.get('chemCompVars').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemTorsions(self):
    ...
    tempVar = list(dataDict.get('chemTorsions').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLinkEnds(self):
    ...
    tempVar = list(dataDict.get('linkEnds').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNamingSystems(self):
    ...
    tempVar = list(dataDict.get('namingSystems').values())
    result = frozenset(tempVar)
    return result
  ...
  def getStereochemistries(self):
    ...
    tempVar = list(dataDict.get('stereochemistries').values())
    result = frozenset(tempVar)
    return result
...
given explicitly
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    atomSysNames = list(dataDict.get('atomSysNames').values())
    ...
    chemCompSysNames = list(dataDict.get('chemCompSysNames').values())
    ...
    chemTorsionSysNames = list(dataDict.get('chemTorsionSysNames').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('atomSysNames').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemCompSysNames').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemTorsionSysNames').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAtomSysNames(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('atomSysNames').values())
      result = set(currentValues)
  ...
  def findAllChemCompSysNames(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemCompSysNames').values())
      result = set(currentValues)
  ...
  def findAllChemTorsionSysNames(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemTorsionSysNames').values())
      result = set(currentValues)
  ...
  def getAtomSysNames(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('atomSysNames').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompSysNames(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemCompSysNames').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemTorsionSysNames(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemTorsionSysNames').values())
    result = frozenset(tempVar)
    return result
...
from one.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemAngles = list(dataDict.get('chemAngles').values())
    for chemAngle in chemAngles:
      if (not (chemAngle in objsToBeDeleted)):
        objsToBeDeleted.add(chemAngle)
        objsToBeChecked.append(chemAngle)

    chemAtomSets = list(dataDict.get('chemAtomSets').values())
    for chemAtomSet in chemAtomSets:
      if (not (chemAtomSet in objsToBeDeleted)):
        objsToBeDeleted.add(chemAtomSet)
        objsToBeChecked.append(chemAtomSet)

    chemAtoms = list(dataDict.get('chemAtoms').values())
    for chemAtom in chemAtoms:
      if (not (chemAtom in objsToBeDeleted)):
        objsToBeDeleted.add(chemAtom)
        objsToBeChecked.append(chemAtom)

    chemBonds = list(dataDict.get('chemBonds').values())
    for chemBond in chemBonds:
      if (not (chemBond in objsToBeDeleted)):
        objsToBeDeleted.add(chemBond)
        objsToBeChecked.append(chemBond)

    chemCompVars = list(dataDict.get('chemCompVars').values())
    for chemCompVar in chemCompVars:
      if (not (chemCompVar in objsToBeDeleted)):
        objsToBeDeleted.add(chemCompVar)
        objsToBeChecked.append(chemCompVar)

    chemTorsions = list(dataDict.get('chemTorsions').values())
    for chemTorsion in chemTorsions:
      if (not (chemTorsion in objsToBeDeleted)):
        objsToBeDeleted.add(chemTorsion)
        objsToBeChecked.append(chemTorsion)

    linkEnds = list(dataDict.get('linkEnds').values())
    ...
    namingSystems = list(dataDict.get('namingSystems').values())
    ...
    stereochemistries = list(dataDict.get('stereochemistries').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemAngles').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemAtomSets').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemAtoms').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemBonds').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemCompVars').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemTorsions').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('linkEnds').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('namingSystems').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('stereochemistries').values())
    for value in values:
      value.checkAllValid(complete)
