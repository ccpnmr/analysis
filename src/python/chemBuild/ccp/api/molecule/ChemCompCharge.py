...
class ChemCompCharge(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    chemAtomCharges = list(dataDict.get('chemAtomCharges').values())
    ...
    chemCompVarCharges = list(dataDict.get('chemCompVarCharges').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemAtomCharges').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemCompVarCharges').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemAtomCharges(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemAtomCharges').values())
      result = set(currentValues)
  ...
  def findAllChemCompVarCharges(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemCompVarCharges').values())
      result = set(currentValues)
  ...
  def getChemAtomCharges(self):
    ...
    tempVar = list(dataDict.get('chemAtomCharges').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompVarCharges(self):
    ...
    tempVar = list(dataDict.get('chemCompVarCharges').values())
    result = frozenset(tempVar)
    return result
