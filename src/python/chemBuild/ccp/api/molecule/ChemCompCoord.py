...
class ChemCompCoord(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemAtomCoords = list(dataDict.get('chemAtomCoords').values())
    ...
    chemCompVarCoords = list(dataDict.get('chemCompVarCoords').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemAtomCoords').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemCompVarCoords').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemAtomCoords(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemAtomCoords').values())
      result = set(currentValues)
  ...
  def findAllChemCompVarCoords(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemCompVarCoords').values())
      result = set(currentValues)
  ...
  def getChemAtomCoords(self):
    ...
    tempVar = list(dataDict.get('chemAtomCoords').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompVarCoords(self):
    ...
    tempVar = list(dataDict.get('chemCompVarCoords').values())
    result = frozenset(tempVar)
    return result
