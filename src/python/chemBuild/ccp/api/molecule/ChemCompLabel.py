...
class ChemCompLabel(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    isotopomers = list(dataDict.get('isotopomers').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('isotopomers').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllIsotopomers(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('isotopomers').values())
  ...
  def getIsotopomers(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('isotopomers').values())
...
same source or are generally used together.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemCompLabels = list(dataDict.get('chemCompLabels').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemCompLabels').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemCompLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemCompLabels').values())
      result = set(currentValues)
  ...
  def getChemCompLabels(self):
    ...
    tempVar = list(dataDict.get('chemCompLabels').values())
    result = frozenset(tempVar)
    return result
