...
class ChemElement(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    isotopes = list(dataDict.get('isotopes').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('isotopes').values())
    for value in values:
  ...
  def findAllIsotopes(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('isotopes').values())
  ...
  def getIsotopes(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('isotopes').values())
...
class ChemElementStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemElements = list(dataDict.get('chemElements').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemElements').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemElements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemElements').values())
      result = set(currentValues)
  ...
  def getChemElements(self):
    ...
    tempVar = list(dataDict.get('chemElements').values())
    result = frozenset(tempVar)
    return result
