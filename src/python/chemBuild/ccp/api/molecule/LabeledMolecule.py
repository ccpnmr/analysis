...
class LabeledMixture(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    molLabelFractions = list(dataDict.get('molLabelFractions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('molLabelFractions').values())
    for value in values:
  ...
  def findAllMolLabelFractions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('molLabelFractions').values())
      result = set(currentValues)
  ...
  def getMolLabelFractions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('molLabelFractions').values())
    result = frozenset(tempVar)
    return result
...
class LabeledMolecule(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    labeledMixtures = list(dataDict.get('labeledMixtures').values())
    ...
    molLabels = list(dataDict.get('molLabels').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('labeledMixtures').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molLabels').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllLabeledMixtures(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('labeledMixtures').values())
      result = set(currentValues)
  ...
  def findAllMolLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molLabels').values())
      result = set(currentValues)
  ...
  def getLabeledMixtures(self):
    ...
    tempVar = list(dataDict.get('labeledMixtures').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolLabels(self):
    ...
    tempVar = list(dataDict.get('molLabels').values())
    result = frozenset(tempVar)
    return result
...
class MolLabel(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    resLabels = list(dataDict.get('resLabels').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('resLabels').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllResLabels(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('resLabels').values())
      result = set(currentValues)
  ...
  def getResLabels(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('resLabels').values())
    result = frozenset(tempVar)
    return result
...
ResLabelFractions.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    atomLabels = list(dataDict.get('atomLabels').values())
    ...
    resLabelFractions = list(dataDict.get('resLabelFractions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('atomLabels').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('resLabelFractions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAtomLabels(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('atomLabels').values())
      result = set(currentValues)
  ...
  def findAllResLabelFractions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('resLabelFractions').values())
      result = set(currentValues)
  ...
  def getAtomLabels(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('atomLabels').values())
    result = frozenset(tempVar)
    return result
  ...
  def getResLabelFractions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('resLabelFractions').values())
    result = frozenset(tempVar)
    return result
