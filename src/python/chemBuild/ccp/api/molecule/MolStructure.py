...
a given set of coordinates.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    coords = list(dataDict.get('coords').values())
    for coord in coords:
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('coords').values())
    for value in values:
  ...
  def findAllCoords(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('coords').values())
      result = set(currentValues)
  ...
  def getCoords(self):
    ...
    if len(dd) < len(models):
      missing = models.difference(x.model for x in list(dd.values()))
      for model in missing:
        Coord(self, model=model)
    result = frozenset(list(dd.values()))
    return result
  ...
  def newCoord(self, **attrlinks):
    ...
    for coord in list(self.__dict__['coords'].values()):
...
trajectory for the MolSystem or part of it.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    coordChains = list(dataDict.get('coordChains').values())
    ...
    dataMatrices = list(dataDict.get('dataMatrices').values())
    ...
    models = list(dataDict.get('models').values())
    for model in models:
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('coordChains').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('dataMatrices').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('models').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllCoordChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('coordChains').values())
      result = set(currentValues)
  ...
  def findAllDataMatrices(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('dataMatrices').values())
      result = set(currentValues)
  ...
  def findAllModels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('models').values())
      result = set(currentValues)
  ...
  def getCoordChains(self):
    ...
    tempVar = list(dataDict.get('coordChains').values())
    result = frozenset(tempVar)
    return result
  ...
  def getDataMatrices(self):
    ...
    tempVar = list(dataDict.get('dataMatrices').values())
    result = frozenset(tempVar)
    return result
  ...
  def getModels(self):
    ...
    tempVar = list(dataDict.get('models').values())
    result = frozenset(tempVar)
    return result
