...
cleared first.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    if (dataDict.get('atomSet') is None):
      ...
      tobjList = list(root.__dict__.get('nmrProjects').values())
    ...
    tobjList = list(root.__dict__.get('nmrConstraintStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    tobjList = list(root.__dict__.get('validationStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
...
creates the Residue and Atom objects corresponding to it. 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chainFragments = list(dataDict.get('chainFragments').values())
    ...
    tobjList = list(root.__dict__.get('dangleStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    residues = list(dataDict.get('residues').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('chainFragments').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('residues').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def createChainFragments(self):
    ...
    for (molType, dd) in list(topdict.items()):
  ...
  def findAllChainFragments(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chainFragments').values())
      result = set(currentValues)
  ...
  def findAllResidues(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('residues').values())
      result = set(currentValues)
  ...
  def getChainFragments(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chainFragments').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolecularMass(self):
    ...
    result = sum(ii * xx.findFirstChemElement(symbol=ss).mass for (ss, ii) in list(dd.items()))
    return result
  ...
  def getResidues(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('residues').values())
    result = frozenset(tempVar)
    return result
...
NMR-observable impurities in an Nmr study). 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chainInteractions = list(dataDict.get('chainInteractions').values())
    for chainInteraction in chainInteractions:
      if (not (chainInteraction in objsToBeDeleted)):
        objsToBeDeleted.add(chainInteraction)
        objsToBeChecked.append(chainInteraction)

    chains = list(dataDict.get('chains').values())
    for chain in chains:
      if (not (chain in objsToBeDeleted)):
    ...
    tobjList = list(root.__dict__.get('nmrEntryStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    molSystemLinks = list(dataDict.get('molSystemLinks').values())
    ...
    molSystemSysNames = list(dataDict.get('molSystemSysNames').values())
    ...
    nonCovalentBonds = list(dataDict.get('nonCovalentBonds').values())
    for nonCovalentBond in nonCovalentBonds:
      if (not (nonCovalentBond in objsToBeDeleted)):
        objsToBeDeleted.add(nonCovalentBond)
        objsToBeChecked.append(nonCovalentBond)
    ...
    structureGroups = list(dataDict.get('structureGroups').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chainInteractions').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chains').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molSystemLinks').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molSystemSysNames').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('nonCovalentBonds').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('structureGroups').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChainInteractions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chainInteractions').values())
      result = set(currentValues)
  ...
  def findAllChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chains').values())
      result = set(currentValues)
  ...
  def findAllMolSystemLinks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molSystemLinks').values())
      result = set(currentValues)
  ...
  def findAllMolSystemSysNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molSystemSysNames').values())
      result = set(currentValues)
  ...
  def findAllNonCovalentBonds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('nonCovalentBonds').values())
      result = set(currentValues)
  ...
  def findAllStructureGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('structureGroups').values())
      result = set(currentValues)
  ...
  def getChainInteractions(self):
    ...
    tempVar = list(dataDict.get('chainInteractions').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChains(self):
    ...
    tempVar = list(dataDict.get('chains').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSystemLinks(self):
    ...
    tempVar = list(dataDict.get('molSystemLinks').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSystemSysNames(self):
    ...
    tempVar = list(dataDict.get('molSystemSysNames').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNonCovalentBonds(self):
    ...
    tempVar = list(dataDict.get('nonCovalentBonds').values())
    result = frozenset(tempVar)
    return result
  ...
  def getStructureGroups(self):
    ...
    tempVar = list(dataDict.get('structureGroups').values())
    result = frozenset(tempVar)
    return result
...
links.
  ...
  def setMolSystemLinkEnds(self, values):
    ...
    if (notOverride):
      ...
      for osv in list(oldSelves.keys()):
...
(Chain)). 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    atoms = list(dataDict.get('atoms').values())
    for atom in atoms:
      if (not (atom in objsToBeDeleted)):
    ...
    molSystemLinkEnds = list(dataDict.get('molSystemLinkEnds').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('atoms').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molSystemLinkEnds').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAtoms(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('atoms').values())
      result = set(currentValues)
  ...
  def findAllMolSystemLinkEnds(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('molSystemLinkEnds').values())
      result = set(currentValues)
  ...
  def getAtoms(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('atoms').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSystemLinkEnds(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('molSystemLinkEnds').values())
    result = frozenset(tempVar)
    return result
