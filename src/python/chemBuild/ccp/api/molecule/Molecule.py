...
the data bypassing the API.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    tobjList = list(root.__dict__.get('annotationStores').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    molResLinkEnds = list(dataDict.get('molResLinkEnds').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('molResLinkEnds').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllMolResLinkEnds(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('molResLinkEnds').values())
      result = set(currentValues)
  ...
  def getMolResLinkEnds(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('molResLinkEnds').values())
    result = frozenset(tempVar)
    return result
...
etc. 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    alignments = list(dataDict.get('alignments').values())
    ...
    tobjList = list(root.__dict__.get('molSystems').values())
    for tobj in tobjList:
      if (not (tobj.__dict__.get('isLoaded'))):
        tobj.load()
    ...
    molResLinks = list(dataDict.get('molResLinks').values())
    for molResLink in molResLinks:
      if (not (molResLink in objsToBeDeleted)):
        objsToBeDeleted.add(molResLink)
        objsToBeChecked.append(molResLink)

    molResidues = list(dataDict.get('molResidues').values())
    for molResidue in molResidues:
      if (not (molResidue in objsToBeDeleted)):
        objsToBeDeleted.add(molResidue)
        objsToBeChecked.append(molResidue)

    molSeqFragments = list(dataDict.get('molSeqFragments').values())
    for molSeqFragment in molSeqFragments:
      if (not (molSeqFragment in objsToBeDeleted)):
        objsToBeDeleted.add(molSeqFragment)
        objsToBeChecked.append(molSeqFragment)

    moleculeSysNames = list(dataDict.get('moleculeSysNames').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('alignments').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molResLinks').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molResidues').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('molSeqFragments').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('moleculeSysNames').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAlignments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('alignments').values())
      result = set(currentValues)
  ...
  def findAllMolResLinks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molResLinks').values())
      result = set(currentValues)
  ...
  def findAllMolResidues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molResidues').values())
      result = set(currentValues)
  ...
  def findAllMolSeqFragments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('molSeqFragments').values())
      result = set(currentValues)
  ...
  def findAllMoleculeSysNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('moleculeSysNames').values())
      result = set(currentValues)
  ...
  def getAlignments(self):
    ...
    tempVar = list(dataDict.get('alignments').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolResLinks(self):
    ...
    tempVar = list(dataDict.get('molResLinks').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolResidues(self):
    ...
    tempVar = list(dataDict.get('molResidues').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSeqFragments(self):
    ...
    tempVar = list(dataDict.get('molSeqFragments').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMoleculeSysNames(self):
    ...
    tempVar = list(dataDict.get('moleculeSysNames').values())
    result = frozenset(tempVar)
    return result
