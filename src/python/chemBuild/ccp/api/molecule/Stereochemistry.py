...
class StereochemistryStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    *Implementation function* - should be called only by API delete 
    ...
    refStereochemistries = list(dataDict.get('refStereochemistries').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('refStereochemistries').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllRefStereochemistries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('refStereochemistries').values())
  ...
  def getRefStereochemistries(self):
    ...
    tempVar = list(dataDict.get('refStereochemistries').values())
