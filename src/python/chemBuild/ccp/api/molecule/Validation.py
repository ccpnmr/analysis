...
class ValidationStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    validationResults = list(dataDict.get('validationResults').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('validationResults').values())
    for value in values:
  ...
  def findAllValidationResults(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('validationResults').values())
      result = set(currentValues)
  ...
  def getValidationResults(self):
    ...
    tempVar = list(dataDict.get('validationResults').values())
