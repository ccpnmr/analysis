...
other depositions?).
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    entryMolecules = list(dataDict.get('entryMolecules').values())
    ...
    relatedEntries = list(dataDict.get('relatedEntries').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('entryMolecules').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('relatedEntries').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllEntryMolecules(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('entryMolecules').values())
      result = set(currentValues)
  ...
  def findAllRelatedEntries(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('relatedEntries').values())
      result = set(currentValues)
  ...
  def getEntryMolecules(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('entryMolecules').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRelatedEntries(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('relatedEntries').values())
    result = frozenset(tempVar)
    return result
...
class NmrEntryStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    entries = list(dataDict.get('entries').values())
    ...
    studies = list(dataDict.get('studies').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('entries').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('studies').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllEntries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('entries').values())
      result = set(currentValues)
  ...
  def findAllStudies(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('studies').values())
      result = set(currentValues)
  ...
  def getEntries(self):
    ...
    tempVar = list(dataDict.get('entries').values())
    result = frozenset(tempVar)
    return result
  ...
  def getStudies(self):
    ...
    tempVar = list(dataDict.get('studies').values())
    result = frozenset(tempVar)
    return result
