...
molecule topologies giving rise to peaks of different sign.
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('expSteps').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('expTransfers').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllExpSteps(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('expSteps').values())
      result = set(currentValues)
  ...
  def findAllExpTransfers(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('expTransfers').values())
      result = set(currentValues)
  ...
  def getExpSteps(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('expSteps').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExpTransfers(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('expTransfers').values())
    result = frozenset(tempVar)
    return result
...
experiment
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refExperiments = list(dataDict.get('refExperiments').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('atomSites').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('expGraphs').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('expMeasurements').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refExperiments').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAtomSites(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('atomSites').values())
      result = set(currentValues)
  ...
  def findAllExpGraphs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('expGraphs').values())
      result = set(currentValues)
  ...
  def findAllExpMeasurements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('expMeasurements').values())
      result = set(currentValues)
  ...
  def findAllRefExperiments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('refExperiments').values())
      result = set(currentValues)
  ...
  def getAtomSites(self):
    ...
    tempVar = list(dataDict.get('atomSites').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExpGraphs(self):
    ...
    tempVar = list(dataDict.get('expGraphs').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExpMeasurements(self):
    ...
    tempVar = list(dataDict.get('expMeasurements').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefExperiments(self):
    ...
    tempVar = list(dataDict.get('refExperiments').values())
    result = frozenset(tempVar)
    return result
...
class RefExpDim(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refExpDimRefs = list(dataDict.get('refExpDimRefs').values())
    for refExpDimRef in refExpDimRefs:
      if (not (refExpDimRef in objsToBeDeleted)):
        objsToBeDeleted.add(refExpDimRef)
        objsToBeChecked.append(refExpDimRef)
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('refExpDimRefs').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllRefExpDimRefs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refExpDimRefs').values())
      result = set(currentValues)
  ...
  def getRefExpDimRefs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refExpDimRefs').values())
    result = frozenset(tempVar)
    return result
...
available in the NmrExpPrototype
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refExpDims = list(dataDict.get('refExpDims').values())
    for refExpDim in refExpDims:
      if (not (refExpDim in objsToBeDeleted)):
        objsToBeDeleted.add(refExpDim)
        objsToBeChecked.append(refExpDim)

    systematicNames = list(dataDict.get('systematicNames').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('refExpDims').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('systematicNames').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllRefExpDims(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refExpDims').values())
      result = set(currentValues)
  ...
  def findAllSystematicNames(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('systematicNames').values())
      result = set(currentValues)
  ...
  def getRefExpDims(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refExpDims').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSystematicNames(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('systematicNames').values())
    result = frozenset(tempVar)
    return result
