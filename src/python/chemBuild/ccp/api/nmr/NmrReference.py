...
the meanValue or the randomCoilValue attribute must be set.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemAtomShiftCorrs = list(dataDict.get('chemAtomShiftCorrs').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('chemAtomShiftCorrs').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemAtomShiftCorrs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemAtomShiftCorrs').values())
  ...
  def getChemAtomShiftCorrs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemAtomShiftCorrs').values())
...
source. 
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemAtomNmrDistribs = list(dataDict.get('chemAtomNmrDistribs').values())
    ...
    chemAtomNmrRefs = list(dataDict.get('chemAtomNmrRefs').values())
    for chemAtomNmrRef in chemAtomNmrRefs:
      if (not (chemAtomNmrRef in objsToBeDeleted)):
        objsToBeDeleted.add(chemAtomNmrRef)
        objsToBeChecked.append(chemAtomNmrRef)

    chemCompVarNmrRefs = list(dataDict.get('chemCompVarNmrRefs').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('chemAtomNmrDistribs').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemAtomNmrRefs').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('chemCompVarNmrRefs').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemAtomNmrDistribs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemAtomNmrDistribs').values())
      result = set(currentValues)
  ...
  def findAllChemAtomNmrRefs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemAtomNmrRefs').values())
      result = set(currentValues)
  ...
  def findAllChemCompVarNmrRefs(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('chemCompVarNmrRefs').values())
      result = set(currentValues)
  ...
  def getChemAtomNmrDistribs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemAtomNmrDistribs').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemAtomNmrRefs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemAtomNmrRefs').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompVarNmrRefs(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('chemCompVarNmrRefs').values())
    result = frozenset(tempVar)
    return result
...
handle, holding information about where the actual data are stored.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    chemCompNmrRefs = list(dataDict.get('chemCompNmrRefs').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('chemCompNmrRefs').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllChemCompNmrRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('chemCompNmrRefs').values())
      result = set(currentValues)
  ...
  def getChemCompNmrRefs(self):
    ...
    tempVar = list(dataDict.get('chemCompNmrRefs').values())
    result = frozenset(tempVar)
    return result
