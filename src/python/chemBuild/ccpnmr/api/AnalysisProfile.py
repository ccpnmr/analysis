...
class AnalysisProfile(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refExpProfiles = list(dataDict.get('refExpProfiles').values())
    ...
    residueProfiles = list(dataDict.get('residueProfiles').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('colorSchemes').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('macros').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refExpProfiles').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('residueProfiles').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllColorSchemes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('colorSchemes').values())
  ...
  def findAllMacros(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('macros').values())
      result = set(currentValues)
  ...
  def findAllRefExpProfiles(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('refExpProfiles').values())
      result = set(currentValues)
  ...
  def findAllResidueProfiles(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('residueProfiles').values())
      result = set(currentValues)
  ...
  def getColorSchemes(self):
    ...
    tempVar = list(dataDict.get('colorSchemes').values())
  ...
  def getMacros(self):
    ...
    tempVar = list(dataDict.get('macros').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefExpProfiles(self):
    ...
    tempVar = list(dataDict.get('refExpProfiles').values())
    result = frozenset(tempVar)
    return result
  ...
  def getResidueProfiles(self):
    ...
    tempVar = list(dataDict.get('residueProfiles').values())
    result = frozenset(tempVar)
    return result
