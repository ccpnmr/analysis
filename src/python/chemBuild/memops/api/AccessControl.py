...
class AccessControlStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    accessObjects = list(dataDict.get('accessObjects').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('accessObjects').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('userGroups').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('users').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAccessObjects(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('accessObjects').values())
  ...
  def findAllUserGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('userGroups').values())
      result = set(currentValues)
  ...
  def findAllUsers(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('users').values())
      result = set(currentValues)
  ...
  def getAccessObjects(self):
    ...
    tempVar = list(dataDict.get('accessObjects').values())
  ...
  def getUserGroups(self):
    ...
    tempVar = list(dataDict.get('userGroups').values())
    result = frozenset(tempVar)
    return result
  ...
  def getUsers(self):
    ...
    tempVar = list(dataDict.get('users').values())
    result = frozenset(tempVar)
    return result
...
class AccessObject(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    permissions = list(dataDict.get('permissions').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('permissions').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllPermissions(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('permissions').values())
      result = set(currentValues)
  ...
  def getPermissions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('permissions').values())
    result = frozenset(tempVar)
    return result
