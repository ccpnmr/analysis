  ...
  def getByNavigation(self, *navigation):
    ...
    for xx in navigation:
      ...
      if isa(result, list):
        ...
        result = frozenset(list(result.values()))
    return result
...
Implementations
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('accessControlStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Affiliation')
    values = list(dataDict.get('affiliationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.AnalysisProfile')
    values = list(dataDict.get('analysisProfiles').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.AnalysisV3')
    values = list(dataDict.get('analysisProjectV3s').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.Analysis')
    values = list(dataDict.get('analysisProjects').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.AnalysisWindow')
    values = list(dataDict.get('analysisWindowStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('molsim.AnnealProtocol')
    values = list(dataDict.get('annealProtocolStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Annotation')
    values = list(dataDict.get('annotationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompCharge')
    values = list(dataDict.get('chemCompCharges').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompCoord')
    values = list(dataDict.get('chemCompCoords').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.ChemComp')
    values = list(dataDict.get('chemComps').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.ChemElement')
    values = list(dataDict.get('chemElementStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Citation')
    values = list(dataDict.get('citationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Classification')
    values = list(dataDict.get('classifications').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Crystallization')
    values = list(dataDict.get('crystallizationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('cambridge.Dangle')
    values = list(dataDict.get('dangleStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.DataLocation')
    values = list(dataDict.get('dataLocationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.DbRef')
    values = list(dataDict.get('databases').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.ExpBlueprint')
    values = list(dataDict.get('expBlueprintStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Experiment')
    values = list(dataDict.get('experimentStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('utrecht.Haddock')
    values = list(dataDict.get('haddockProjects').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Holder')
    values = list(dataDict.get('holderStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Instrument')
    values = list(dataDict.get('instrumentStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.KeywordDefinition')
    values = list(dataDict.get('keywordDefinitionStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.LabeledMolecule')
    values = list(dataDict.get('labeledMolecules').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompLabel')
    values = list(dataDict.get('labelingSchemes').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.AnalysisLayout')
    values = list(dataDict.get('layouts').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Location')
    values = list(dataDict.get('locationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Method')
    values = list(dataDict.get('methodStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('molsim.Symmetry')
    values = list(dataDict.get('molSystemSymmetrySets').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.MolSystem')
    values = list(dataDict.get('molSystems').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.Molecule')
    values = list(dataDict.get('molecules').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccpnmr.NameMapping')
    values = list(dataDict.get('nameMappingStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrCalc')
    values = list(dataDict.get('nmrCalcStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrConstraint')
    values = list(dataDict.get('nmrConstraintStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrEntry')
    values = list(dataDict.get('nmrEntryStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrExpPrototype')
    values = list(dataDict.get('nmrExpPrototypes').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.Nmr')
    values = list(dataDict.get('nmrProjects').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrReference')
    values = list(dataDict.get('nmrReferenceStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.nmr.NmrScreen')
    values = list(dataDict.get('nmrScreens').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('packageLocators').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Protocol')
    values = list(dataDict.get('protocolStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.RefData')
    values = list(dataDict.get('refDataStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.RefSampleComponent')
    values = list(dataDict.get('refSampleComponentStores').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('repositories').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Sample')
    values = list(dataDict.get('sampleStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.Stereochemistry')
    values = list(dataDict.get('stereochemistryStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.MolStructure')
    values = list(dataDict.get('structureEnsembles').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.lims.Target')
    values = list(dataDict.get('targetStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.general.Taxonomy')
    values = list(dataDict.get('taxonomies').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('ccp.molecule.Validation')
    values = list(dataDict.get('validationStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('cambridge.WmsProtocol')
    values = list(dataDict.get('wmsProtocols').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('cambridge.WmsQuery')
    values = list(dataDict.get('wmsQueryStores').values())
    for value in values:
      value.checkAllValid(complete)

    root = self
    root.refreshTopObjects('cambridge.Wms')
    values = list(dataDict.get('wmsSegments').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAccessControlStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('memops.AccessControl')
      currentValues = list(dataDict.get('accessControlStores').values())
  ...
  def findAllAffiliationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Affiliation')
      currentValues = list(dataDict.get('affiliationStores').values())
      result = set(currentValues)
  ...
  def findAllAnalysisProfiles(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.AnalysisProfile')
      currentValues = list(dataDict.get('analysisProfiles').values())
      result = set(currentValues)
  ...
  def findAllAnalysisProjectV3s(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.AnalysisV3')
      currentValues = list(dataDict.get('analysisProjectV3s').values())
      result = set(currentValues)
  ...
  def findAllAnalysisProjects(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.Analysis')
      currentValues = list(dataDict.get('analysisProjects').values())
      result = set(currentValues)
  ...
  def findAllAnalysisWindowStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.AnalysisWindow')
      currentValues = list(dataDict.get('analysisWindowStores').values())
      result = set(currentValues)
  ...
  def findAllAnnealProtocolStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('molsim.AnnealProtocol')
      currentValues = list(dataDict.get('annealProtocolStores').values())
      result = set(currentValues)
  ...
  def findAllAnnotationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Annotation')
      currentValues = list(dataDict.get('annotationStores').values())
      result = set(currentValues)
  ...
  def findAllChemCompCharges(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.ChemCompCharge')
      currentValues = list(dataDict.get('chemCompCharges').values())
      result = set(currentValues)
  ...
  def findAllChemCompCoords(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.ChemCompCoord')
      currentValues = list(dataDict.get('chemCompCoords').values())
      result = set(currentValues)
  ...
  def findAllChemComps(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.ChemComp')
      currentValues = list(dataDict.get('chemComps').values())
      result = set(currentValues)
  ...
  def findAllChemElementStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.ChemElement')
      currentValues = list(dataDict.get('chemElementStores').values())
      result = set(currentValues)
  ...
  def findAllCitationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Citation')
      currentValues = list(dataDict.get('citationStores').values())
      result = set(currentValues)
  ...
  def findAllClassifications(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Classification')
      currentValues = list(dataDict.get('classifications').values())
      result = set(currentValues)
  ...
  def findAllCrystallizationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Crystallization')
      currentValues = list(dataDict.get('crystallizationStores').values())
      result = set(currentValues)
  ...
  def findAllDangleStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('cambridge.Dangle')
      currentValues = list(dataDict.get('dangleStores').values())
      result = set(currentValues)
  ...
  def findAllDataLocationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.DataLocation')
      currentValues = list(dataDict.get('dataLocationStores').values())
      result = set(currentValues)
  ...
  def findAllDatabases(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.DbRef')
      currentValues = list(dataDict.get('databases').values())
      result = set(currentValues)
  ...
  def findAllExpBlueprintStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.ExpBlueprint')
      currentValues = list(dataDict.get('expBlueprintStores').values())
      result = set(currentValues)
  ...
  def findAllExperimentStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Experiment')
      currentValues = list(dataDict.get('experimentStores').values())
      result = set(currentValues)
  ...
  def findAllHaddockProjects(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('utrecht.Haddock')
      currentValues = list(dataDict.get('haddockProjects').values())
      result = set(currentValues)
  ...
  def findAllHolderStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Holder')
      currentValues = list(dataDict.get('holderStores').values())
      result = set(currentValues)
  ...
  def findAllInstrumentStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Instrument')
      currentValues = list(dataDict.get('instrumentStores').values())
      result = set(currentValues)
  ...
  def findAllKeywordDefinitionStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.KeywordDefinition')
      currentValues = list(dataDict.get('keywordDefinitionStores').values())
      result = set(currentValues)
  ...
  def findAllLabeledMolecules(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.LabeledMolecule')
      currentValues = list(dataDict.get('labeledMolecules').values())
      result = set(currentValues)
  ...
  def findAllLabelingSchemes(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.ChemCompLabel')
      currentValues = list(dataDict.get('labelingSchemes').values())
      result = set(currentValues)
  ...
  def findAllLayouts(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.AnalysisLayout')
      currentValues = list(dataDict.get('layouts').values())
      result = set(currentValues)
  ...
  def findAllLocationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Location')
      currentValues = list(dataDict.get('locationStores').values())
      result = set(currentValues)
  ...
  def findAllMethodStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Method')
      currentValues = list(dataDict.get('methodStores').values())
      result = set(currentValues)
  ...
  def findAllMolSystemSymmetrySets(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('molsim.Symmetry')
      currentValues = list(dataDict.get('molSystemSymmetrySets').values())
      result = set(currentValues)
  ...
  def findAllMolSystems(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.MolSystem')
      currentValues = list(dataDict.get('molSystems').values())
      result = set(currentValues)
  ...
  def findAllMolecules(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.Molecule')
      currentValues = list(dataDict.get('molecules').values())
      result = set(currentValues)
  ...
  def findAllNameMappingStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.NameMapping')
      currentValues = list(dataDict.get('nameMappingStores').values())
      result = set(currentValues)
  ...
  def findAllNmrCalcStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrCalc')
      currentValues = list(dataDict.get('nmrCalcStores').values())
      result = set(currentValues)
  ...
  def findAllNmrConstraintStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrConstraint')
      currentValues = list(dataDict.get('nmrConstraintStores').values())
      result = set(currentValues)
  ...
  def findAllNmrEntryStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrEntry')
      currentValues = list(dataDict.get('nmrEntryStores').values())
      result = set(currentValues)
  ...
  def findAllNmrExpPrototypes(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrExpPrototype')
      currentValues = list(dataDict.get('nmrExpPrototypes').values())
      result = set(currentValues)
  ...
  def findAllNmrProjects(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.Nmr')
      currentValues = list(dataDict.get('nmrProjects').values())
      result = set(currentValues)
  ...
  def findAllNmrReferenceStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrReference')
      currentValues = list(dataDict.get('nmrReferenceStores').values())
      result = set(currentValues)
  ...
  def findAllNmrScreens(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.nmr.NmrScreen')
      currentValues = list(dataDict.get('nmrScreens').values())
      result = set(currentValues)
  ...
  def findAllPackageLocators(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('packageLocators').values())
      result = set(currentValues)
  ...
  def findAllProtocolStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Protocol')
      currentValues = list(dataDict.get('protocolStores').values())
      result = set(currentValues)
  ...
  def findAllRefDataStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.RefData')
      currentValues = list(dataDict.get('refDataStores').values())
      result = set(currentValues)
  ...
  def findAllRefSampleComponentStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.RefSampleComponent')
      currentValues = list(dataDict.get('refSampleComponentStores').values())
      result = set(currentValues)
  ...
  def findAllRepositories(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('repositories').values())
      result = set(currentValues)
  ...
  def findAllSampleStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Sample')
      currentValues = list(dataDict.get('sampleStores').values())
      result = set(currentValues)
  ...
  def findAllStereochemistryStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.Stereochemistry')
      currentValues = list(dataDict.get('stereochemistryStores').values())
      result = set(currentValues)
  ...
  def findAllStructureEnsembles(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.MolStructure')
      currentValues = list(dataDict.get('structureEnsembles').values())
      result = set(currentValues)
  ...
  def findAllTargetStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.lims.Target')
      currentValues = list(dataDict.get('targetStores').values())
      result = set(currentValues)
  ...
  def findAllTaxonomies(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.general.Taxonomy')
      currentValues = list(dataDict.get('taxonomies').values())
      result = set(currentValues)
  ...
  def findAllValidationStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccp.molecule.Validation')
      currentValues = list(dataDict.get('validationStores').values())
      result = set(currentValues)
  ...
  def findAllWmsProtocols(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('cambridge.WmsProtocol')
      currentValues = list(dataDict.get('wmsProtocols').values())
      result = set(currentValues)
  ...
  def findAllWmsQueryStores(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('cambridge.WmsQuery')
      currentValues = list(dataDict.get('wmsQueryStores').values())
      result = set(currentValues)
  ...
  def findAllWmsSegments(self, **conditions):
    ...
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('cambridge.Wms')
      currentValues = list(dataDict.get('wmsSegments').values())
      result = set(currentValues)
  ...
  def findFirstTopObject(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = set(x for x in list(dataDict.get('topObjects').values()) if not x.isDeleted)
      result = None
  ...
  def getAccessControlStores(self):
    ...
    root = self
    root.refreshTopObjects('memops.AccessControl')
    tempVar = list(dataDict.get('accessControlStores').values())
  ...
  def getAffiliationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Affiliation')
    tempVar = list(dataDict.get('affiliationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnalysisProfiles(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.AnalysisProfile')
    tempVar = list(dataDict.get('analysisProfiles').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnalysisProjectV3s(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.AnalysisV3')
    tempVar = list(dataDict.get('analysisProjectV3s').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnalysisProjects(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.Analysis')
    tempVar = list(dataDict.get('analysisProjects').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnalysisWindowStores(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.AnalysisWindow')
    tempVar = list(dataDict.get('analysisWindowStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnnealProtocolStores(self):
    ...
    root = self
    root.refreshTopObjects('molsim.AnnealProtocol')
    tempVar = list(dataDict.get('annealProtocolStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getAnnotationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Annotation')
    tempVar = list(dataDict.get('annotationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompCharges(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompCharge')
    tempVar = list(dataDict.get('chemCompCharges').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemCompCoords(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompCoord')
    tempVar = list(dataDict.get('chemCompCoords').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemComps(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.ChemComp')
    tempVar = list(dataDict.get('chemComps').values())
    result = frozenset(tempVar)
    return result
  ...
  def getChemElementStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.ChemElement')
    tempVar = list(dataDict.get('chemElementStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getCitationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Citation')
    tempVar = list(dataDict.get('citationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getClassifications(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Classification')
    tempVar = list(dataDict.get('classifications').values())
    result = frozenset(tempVar)
    return result
  ...
  def getCrystallizationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Crystallization')
    tempVar = list(dataDict.get('crystallizationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getDangleStores(self):
    ...
    root = self
    root.refreshTopObjects('cambridge.Dangle')
    tempVar = list(dataDict.get('dangleStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getDataLocationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.DataLocation')
    tempVar = list(dataDict.get('dataLocationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getDatabases(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.DbRef')
    tempVar = list(dataDict.get('databases').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExpBlueprintStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.ExpBlueprint')
    tempVar = list(dataDict.get('expBlueprintStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getExperimentStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Experiment')
    tempVar = list(dataDict.get('experimentStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getHaddockProjects(self):
    ...
    root = self
    root.refreshTopObjects('utrecht.Haddock')
    tempVar = list(dataDict.get('haddockProjects').values())
    result = frozenset(tempVar)
    return result
  ...
  def getHolderStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Holder')
    tempVar = list(dataDict.get('holderStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getInstrumentStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Instrument')
    tempVar = list(dataDict.get('instrumentStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getKeywordDefinitionStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.KeywordDefinition')
    tempVar = list(dataDict.get('keywordDefinitionStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLabeledMolecules(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.LabeledMolecule')
    tempVar = list(dataDict.get('labeledMolecules').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLabelingSchemes(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.ChemCompLabel')
    tempVar = list(dataDict.get('labelingSchemes').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLayouts(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.AnalysisLayout')
    tempVar = list(dataDict.get('layouts').values())
    result = frozenset(tempVar)
    return result
  ...
  def getLocationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Location')
    tempVar = list(dataDict.get('locationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMethodStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Method')
    tempVar = list(dataDict.get('methodStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSystemSymmetrySets(self):
    ...
    root = self
    root.refreshTopObjects('molsim.Symmetry')
    tempVar = list(dataDict.get('molSystemSymmetrySets').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolSystems(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.MolSystem')
    tempVar = list(dataDict.get('molSystems').values())
    result = frozenset(tempVar)
    return result
  ...
  def getMolecules(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.Molecule')
    tempVar = list(dataDict.get('molecules').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNameMappingStores(self):
    ...
    root = self
    root.refreshTopObjects('ccpnmr.NameMapping')
    tempVar = list(dataDict.get('nameMappingStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrCalcStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrCalc')
    tempVar = list(dataDict.get('nmrCalcStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrConstraintStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrConstraint')
    tempVar = list(dataDict.get('nmrConstraintStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrEntryStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrEntry')
    tempVar = list(dataDict.get('nmrEntryStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrExpPrototypes(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrExpPrototype')
    tempVar = list(dataDict.get('nmrExpPrototypes').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrProjects(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.Nmr')
    tempVar = list(dataDict.get('nmrProjects').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrReferenceStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrReference')
    tempVar = list(dataDict.get('nmrReferenceStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getNmrScreens(self):
    ...
    root = self
    root.refreshTopObjects('ccp.nmr.NmrScreen')
    tempVar = list(dataDict.get('nmrScreens').values())
    result = frozenset(tempVar)
    return result
  ...
  def getPackageLocators(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('packageLocators').values())
    result = frozenset(tempVar)
    return result
  ...
  def getProtocolStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Protocol')
    tempVar = list(dataDict.get('protocolStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefDataStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.RefData')
    tempVar = list(dataDict.get('refDataStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefSampleComponentStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.RefSampleComponent')
    tempVar = list(dataDict.get('refSampleComponentStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRepositories(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('repositories').values())
    result = frozenset(tempVar)
    return result
  ...
  def getSampleStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Sample')
    tempVar = list(dataDict.get('sampleStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getStereochemistryStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.Stereochemistry')
    tempVar = list(dataDict.get('stereochemistryStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getStructureEnsembles(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.MolStructure')
    tempVar = list(dataDict.get('structureEnsembles').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTargetStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.lims.Target')
    tempVar = list(dataDict.get('targetStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTaxonomies(self):
    ...
    root = self
    root.refreshTopObjects('ccp.general.Taxonomy')
    tempVar = list(dataDict.get('taxonomies').values())
    result = frozenset(tempVar)
    return result
  ...
  def getTopObjects(self):
    ...
    """
    dataDict = self.__dict__
    result = set(x for x in list(dataDict.get('topObjects').values()) if not x.isDeleted)
    result = frozenset(result)
    return result
  ...
  def getValidationStores(self):
    ...
    root = self
    root.refreshTopObjects('ccp.molecule.Validation')
    tempVar = list(dataDict.get('validationStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getWmsProtocols(self):
    ...
    root = self
    root.refreshTopObjects('cambridge.WmsProtocol')
    tempVar = list(dataDict.get('wmsProtocols').values())
    result = frozenset(tempVar)
    return result
  ...
  def getWmsQueryStores(self):
    ...
    root = self
    root.refreshTopObjects('cambridge.WmsQuery')
    tempVar = list(dataDict.get('wmsQueryStores').values())
    result = frozenset(tempVar)
    return result
  ...
  def getWmsSegments(self):
    ...
    root = self
    root.refreshTopObjects('cambridge.Wms')
    tempVar = list(dataDict.get('wmsSegments').values())
    result = frozenset(tempVar)
    return result
  ...
  def saveAll(self):
    ...
    # NB must be done by direct access
    for topObj in list(self.__dict__['topObjects'].values()):
      if topObj.isDeleted:
...
class Repository(ImplementationObject):
  ...
  def getFileLocation(self, packageName):
    ...
    if protocol == 'file':
      from memops.universal import Io as uniIo
      dataLocation = url.getDataLocation()
      # HACK to get chemBuild to work the way directories now set up
      if packageName == 'ccp.molecule.ChemElement':
        import os
        dataLocation = os.path.join(os.path.dirname(dataLocation), 'chemBuild', os.path.basename(dataLocation))
      #result = uniIo.joinPath(url.getDataLocation(), *packageName.split('.'))
      result = uniIo.joinPath(dataLocation, *packageName.split('.'))
