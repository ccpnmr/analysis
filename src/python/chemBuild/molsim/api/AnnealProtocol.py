...
general terms.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    annealStages = list(dataDict.get('annealStages').values())
    ...
    energyTerms = list(dataDict.get('energyTerms').values())
    ...
    tobjList = list(root.__dict__.get('haddockProjects').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('annealStages').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('energyTerms').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAnnealStages(self, **conditions):
    ...
    if (nConditions == 0):
      currentValues = list(dataDict.get('annealStages').values())
  ...
  def findAllEnergyTerms(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('energyTerms').values())
      result = set(currentValues)
  ...
  def getAnnealStages(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('annealStages').values())
  ...
  def getEnergyTerms(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('energyTerms').values())
    result = frozenset(tempVar)
    return result
...
class AnnealProtocolStore(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    annealProtocols = list(dataDict.get('annealProtocols').values())
    ...
    refPotentialTerms = list(dataDict.get('refPotentialTerms').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('annealProtocols').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('refPotentialTerms').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllAnnealProtocols(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('annealProtocols').values())
      result = set(currentValues)
  ...
  def findAllRefPotentialTerms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('refPotentialTerms').values())
      result = set(currentValues)
  ...
  def getAnnealProtocols(self):
    ...
    tempVar = list(dataDict.get('annealProtocols').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRefPotentialTerms(self):
    ...
    tempVar = list(dataDict.get('refPotentialTerms').values())
    result = frozenset(tempVar)
    return result
...
refPotentialTerms
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    potentialScales = list(dataDict.get('potentialScales').values())
    for potentialScale in potentialScales:
      if (not (potentialScale in objsToBeDeleted)):
        objsToBeDeleted.add(potentialScale)
        objsToBeChecked.append(potentialScale)
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('potentialScales').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllPotentialScales(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('potentialScales').values())
      result = set(currentValues)
  ...
  def getPotentialScales(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('potentialScales').values())
    result = frozenset(tempVar)
    return result
...
interpretation generally requires reference to the application.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    refTermParameters = list(dataDict.get('refTermParameters').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('refTermParameters').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllRefTermParameters(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('refTermParameters').values())
      result = set(currentValues)
  ...
  def getRefTermParameters(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('refTermParameters').values())
    result = frozenset(tempVar)
    return result
