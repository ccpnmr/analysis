...
class MolSystemSymmetrySet(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    symmetries_s = list(dataDict.get('symmetries').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    values = list(dataDict.get('symmetries').values())
    for value in values:
  ...
  def findAllSymmetries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('symmetries').values())
  ...
  def getSymmetries(self):
    ...
    tempVar = list(dataDict.get('symmetries').values())
...
a multichain MolSystem.
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    segments = list(dataDict.get('segments').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('segments').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllSegments(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('segments').values())
      result = set(currentValues)
  ...
  def getSegments(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('segments').values())
    result = frozenset(tempVar)
    return result
