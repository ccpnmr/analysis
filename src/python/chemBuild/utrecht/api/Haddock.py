...
class HaddockEnergyTerm(memops.api.Implementation.DataObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    energyTermParameters = list(dataDict.get('energyTermParameters').values())
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('energyTermParameters').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllEnergyTermParameters(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('energyTermParameters').values())
      result = set(currentValues)
  ...
  def getEnergyTermParameters(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('energyTermParameters').values())
    result = frozenset(tempVar)
    return result
...
class HaddockProject(memops.api.Implementation.TopObject):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    haddockPartners = list(dataDict.get('haddockPartners').values())
    ...
    runs = list(dataDict.get('runs').values())
    for run in runs:
      if (not (run in objsToBeDeleted)):
  ...
  def checkAllValid(self, complete=False):
    ...
    self.checkValid(complete)
    values = list(dataDict.get('haddockPartners').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('runs').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllHaddockPartners(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('haddockPartners').values())
      result = set(currentValues)
  ...
  def findAllRuns(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      currentValues = list(dataDict.get('runs').values())
      result = set(currentValues)
  ...
  def getHaddockPartners(self):
    ...
    tempVar = list(dataDict.get('haddockPartners').values())
    result = frozenset(tempVar)
    return result
  ...
  def getRuns(self):
    ...
    tempVar = list(dataDict.get('runs').values())
    result = frozenset(tempVar)
    return result
...
class Run(memops.api.Implementation.DataObject):
  ...
  def checkAllValid(self, complete=False):
    ...
    dataDict = self.__dict__
    self.checkValid(complete)
    values = list(dataDict.get('haddockEnergyTerms').values())
    for value in values:
      value.checkAllValid(complete)

    values = list(dataDict.get('scoringWeights').values())
    for value in values:
      value.checkAllValid(complete)
  ...
  def findAllHaddockEnergyTerms(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('haddockEnergyTerms').values())
      result = set(currentValues)
  ...
  def findAllScoringWeights(self, **conditions):
    ...
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = list(dataDict.get('scoringWeights').values())
      result = set(currentValues)
  ...
  def getHaddockEnergyTerms(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('haddockEnergyTerms').values())
    result = frozenset(tempVar)
    return result
  ...
  def getScoringWeights(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = list(dataDict.get('scoringWeights').values())
    result = frozenset(tempVar)
    return result
